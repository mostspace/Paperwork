    ...
    <div class="mb-20 px-6 pb-6">
      ...
      <div class="row g-6">
        ...
        <div class="col-12 col-lg-6 d-flex flex-column">
          ...
          <!--begin::Card-->
          <div class="d-flex flex-column gap-6 flex-fill border pw-border-stroke rounded-3 px-4 py-5 overflow-x-auto">
            <!--begin::Yetki seti-->
            <table class="table align-middle gx-5 gy-0">
              <tr>
                <td>
                  <label class="form-label mb-0 fw-semibold" for="pw_yetki_seti">Yetki Seti</label>
                </td>
                <td>
                  <select class="form-select form-select-solid fs-8 py-3 px-4" data-control="select2" data-placeholder="Seçim Yapın" id="pw_yetki_seti">
                    <option></option>
                ...
                <td>
                  <button type="button" class="btn p-0" data-bs-toggle="tooltip" data-bs-custom-class="tooltip-inverse" data-bs-placement="bottom" title="Özel yetki setlerinde de ara">
                    <i class="fa-solid fa-filter fs-base pw-text-neutral-300"></i>
                  </button>
                </td>
              </tr>
            </table>
            ...
            <div class="row g-8">
              ...
              <div class="col-5 d-flex flex-column">
                <!--begin::Menu-->
                <div class="menu menu-rounded menu-column menu-active-bg menu-hover-bg flex-fill fs-8 fw-semibold border pw-border-stroke rounded" id="#kt_aside_menu" data-kt-menu="true">
                  <!--begin::Menu item-->
                  <div class="menu-item">
                    <a href="javascript:void(0)" class="menu-link">
                      <span class="menu-icon">
                        <i class="fa-solid fa-user fs-base pw-text-primary-300"></i>
                      </span>
                      <span class="menu-title pw-text-neutral-700">Ayşe Berçin</span>
                    </a>
                  </div>
                  <!--end::Menu item-->
                  ...
                  <div class="menu-item">
                    <a href="javascript:void(0)" class="menu-link">
                      ...
                      <span class="menu-title pw-text-neutral-700">Göksel Aydemir</span>
                    </a>
                  </div>
                  <!--end::Menu item-->
                  ...
                  <!--begin::Menu item-->
                  <div class="menu-item">
                    <a href="javascript:void(0)" class="menu-link active border-2 border-start border-primary">
                      <span class="menu-icon">
                        <i class="fa-solid fa-user fs-base pw-text-primary-300"></i>
                      </span>
                      <span class="menu-title pw-text-neutral-700">Ezgi Çelik</span>
                    </a>
                  </div>
                  <!--end::Menu item-->
                  ...
                  <div class="menu-item">
                    <a href="javascript:void(0)" class="menu-link">
                      <span class="menu-icon">
                        <i class="fa-solid fa-users fs-base pw-text-primary-300"></i>
                      </span>
                      <span class="menu-title pw-text-neutral-700">PW Destek Ekibi</span>
                    </a>
                  </div>
                  <!--end::Menu item-->
                  ...
                  <div class="menu-item">
                    <a href="javascript:void(0)" class="menu-link">
                      <span class="menu-icon">
                        <i class="fa-solid fa-user-tag fs-base pw-text-primary-300"></i>
                      </span>
                      <span class="menu-title pw-text-neutral-700">Bilet Kullanıcısı</span>
                    </a>
                  </div>
                  <!--end::Menu item-->
                  ...
                  <div class="menu-item">
                    <a href="javascript:void(0)" class="menu-link">
                      <span class="menu-icon">
                        <i class="fa-solid fa-user-check fs-base pw-text-primary-300"></i>
                      </span>
                      <span class="menu-title pw-text-neutral-700">Nesne Sahibi</span>
                    </a>
                  </div>
                  <!--end::Menu item-->
                  ...
                  <div class="menu-item">
                    <a href="javascript:void(0)" class="menu-link">
                      <span class="menu-icon">
                        <i class="fa-solid fa-screen-users fs-base pw-text-primary-300"></i>
                      </span>
                      <span class="menu-title pw-text-neutral-700">Tüm Kullanıcılar</span>
                    </a>
                  </div>
                  <!--end::Menu item-->
                </div>
              ...
              <div class="col-7">
                ...
                <div class="d-flex flex-column gap-5">
                  <!--begin::Title-->
                  <h3 class="text-black fs-7 fw-bold">Temel Yetkiler</h3>
                  <!--end::Title-->

                  <!--begin::List-->
                  <div class="d-flex flex-column gap-4">
                    <!--begin::Item-->
                    <div class="d-flex align-items-center gap-4 text-black fs-8">
                      <i class="fa-solid fa-check fs-7 pw-text-success-500"></i>
                      Görme
                    </div>
                    <!--end::Item-->
                ...
                <div class="d-flex flex-column gap-5 mt-7">
                  <!--begin::Title-->
                  <h3 class="text-black fs-7 fw-bold">Belgeler</h3>
                  <!--end::Title-->
                  ...
                  <div class="d-flex flex-column gap-4">
                    ...
                    <div class="d-flex align-items-center gap-4 text-black fs-8">
                      <i class="fa-solid fa-check fs-7 pw-text-success-500"></i>
                      Elektronik Posta ile Gönderilebilir
                    </div>
                    <!--end::Item-->
