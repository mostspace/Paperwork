  ...
  <div class="app-main flex-column flex-row-fluid" id="kt_app_main">
    ...
    <div class="mb-20 px-6 pb-6">
      ...
      <div class="row g-6">
        ...
        <div class="col-12 col-lg-6">
          <!--begin::Back button-->
          <a href="/belgeler/kabinet/" class="btn btn-outline btn-outline-primary btn-active-light-primary py-3 px-6 fs-7">
          ...
          <!--begin::Card-->
          <div class="border pw-border-stroke rounded-3 py-6 px-3 h-600px mt-4"></div>
          <!--end::Card-->
        </div>
        <!--end::Col-->
      </div>
...
<div id="panoDropdown" class="d-none app-navbar-item ms-1 ms-md-3">
  ...
  <div class="menu menu-sub menu-sub-dropdown w-200px" data-kt-menu="true" id="pw_pano" data-popper-placement="bottom-start">
    <div class="d-flex flex-column">
      <!--begin::Item-->
      <div class="btn btn-active-light-secondary pw-text-neutral-800 fw-semibold fs-7 text-start py-3 px-4 rounded-0">
