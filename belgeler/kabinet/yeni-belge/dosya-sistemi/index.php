            ...
            <div class="stepper pw-stepper-primary" id="kt_stepper_example_basic">
              ...
              <form class="form" novalidate="novalidate" id="kt_stepper_example_basic_form">
                ...
                <div class="mt-6">
                        ...
                        <tbody>
                          ...
                          <tr>
                            <td colspan="2">
                              ...
                              <div class="fv-row">
                                <!--begin::Dropzone-->
                                <div class="dropzone" id="pw_belge_dropzone">
                                  <!--begin::Message-->
                                  <div class="dz-message needsclick align-teims-center justify-content-center text-center">
                                    <!--begin::Info-->
                                    <h3 class="fs-7 fw-semibold pw-text-neutral-900 mb-0"><span class="pw-text-primary-500">Dosya Seçiniz</span> veya Dosyayı Buraya Sürükleyin</h3>
                                    <!--end::Info-->
                                  </div>
                                </div>
                                <!--end::Dropzone-->
                  ...
                  <div class="flex-column pending" data-kt-stepper-element="content">
                    <div class="table-responsive">
                      <table class="table gx-3 gy-2">
                        <tbody>
                          <!--begin::Row-->
                          <tr>
                            <td><label class="form-label fs-base fw-bolder" for="pw_bildirme_saati">Bildirme Saati</label></td>
                            <td>
                              <div class="position-relative">
                                <span class="position-absolute top-50 translate-middle-y fs-base ms-4">
                                  <i class="fa-solid fa-clock pw-text-neutral-300"></i>
                                </span>
                                <input type="text" class="form-control form-control-solid fs-8 py-3 ps-10 pe-4" id="pw_bildirme_saati" />
                              </div>
                            </td>
                          </tr>
                          <!--end::Row-->
                          ...
                          <!--begin::Row-->
                          <tr>
                            <td><label class="form-label fs-base fw-bolder" for="pw_bildirme_tarihi">Bildirme Tarihi</label></td>
                            <td>
                              <div class="position-relative">
                                <span class="position-absolute top-50 translate-middle-y fs-base ms-4">
                                  <i class="fa-solid fa-calendar-days pw-text-neutral-300"></i>
                                </span>
                                <input type="text" class="form-control form-control-solid fs-8 py-3 ps-10 pe-4" placeholder="GG/AA/YY" id="pw_bildirme_tarihi" />
                              </div>
                            </td>
                          </tr>
                          <!--end::Row-->
                          ...
                          <!--begin::Row-->
                          <tr>
                            <td><label class="form-label fs-base fw-bolder" for="pw_calisan_platform">Çalışan Platform</label></td>
                            <td>
                              <input type="text" class="form-control form-control-solid fs-8 py-3 ps-10 pe-4" id="pw_calisan_platform" />
                            </td>
                          </tr>
                          <!--end::Row-->
                          ...
                          <!--begin::Row-->
                          <tr>
                            <td><label class="form-label fs-base fw-bolder" for="pw_cozumleme_tarih_saati">Çözümleme Tarih Saati</label></td>
                            <td>
                              <div class="position-relative">
                                <span class="position-absolute top-50 translate-middle-y fs-base ms-4">
                                  <i class="fa-solid fa-calendar-days pw-text-neutral-300"></i>
                                </span>
                                <input type="text" class="form-control form-control-solid fs-8 py-3 ps-10 pe-4" placeholder="GG/AA/YY" id="pw_cozumleme_tarih_saati" />
                              </div>
                            </td>
                          </tr>
                          <!--end::Row-->
                          ...
                          <!--begin::Row-->
                          <tr>
                            <td><label class="form-label fs-base fw-bolder" for="pw_gelistirici">Geliştrici</label></td>
                            <td>
                              <input type="text" class="form-control form-control-solid fs-8 py-3 ps-10 pe-4" id="pw_gelistirici" />
                            </td>
                          </tr>
                          <!--end::Row-->
                          ...
                          <!--begin::Row-->
                          <tr>
                            <td><label class="form-label fs-base fw-bolder" for="pw_yonetici">Yönetici</label></td>
                            <td>
                              <input type="text" class="form-control form-control-solid fs-8 py-3 ps-10 pe-4" id="pw_yonetici" />
                            </td>
                          </tr>
                          <!--end::Row-->
                          ...
                          <tr>
                            <td colspan="2">
                              <div class="d-flex flex-column gap-2">
                                <label class="form-label fs-base fw-bolder">Bilgiler</label>

                                <!--begin::Button-->
                                <button type="button" class="btn p-0 fs-9 fs-semibold d-inline-flex align-items-center gap-2" data-bs-toggle="modal" data-bs-target="#bilgi_ekle">
                                  <div class="w-25px h-25px pw-bg-neutral-50 rounded-0.20rem d-inline-flex align-items-center justify-content-center">
                                    <i class="fa-solid fa-circle-plus pw-text-primary-500 fs-7"></i>
                                  </div>
                                </button>
                                <!--end::Button-->
                                ...
                                <div class="table-responsive overflow-x-auto">
                                  <!--begin::Table-->
                                  <table class="table table-row-bordered border pw-table-border-gray pw-dark-bg-table table-rounded w-max-content min-w-100 gs-8">
                                    <thead>
                                    ...
                                    <tbody class="fw-medium pw-text-neutral-700 fs-9 fw-semibold">
                                      <tr>
                                        <td>09/06/2023</td>
                                        <td>-</td>
                                      </tr>
                ...
                <!--begin::Actions-->
                <div class="text-end">
                    <button type="button" class="btn btn-primary px-6 py-4" data-kt-stepper-action="submit">
...
<!--begin::Modal-->
<div class="modal fade" tabindex="-1" id="bilgi_ekle" role="dialog">
  <div class="modal-dialog modal-dialog-centered modal-lg mw-575px">
    <div class="modal-content">
      <div class="modal-header border pb-3">
        <h3 class="modal-title fs-5">Bilgi Ekle</h3>
      </div>
      ...
      <form>
          ...
          <div class="table-responsive overflow-x-auto overflow-lg-hidden">
            <table class="table w-min-content w-100 align-middle gy-5 gx-4">
              <tbody>
                ...
                <tr>
                  <td>
                    <label class="form-label fs-base fw-bolder" for="pw_bilgi_ekle_test_tarihi">Test Tarihi</label>
                  </td>
                  <td>
                    <div class="position-relative">
                      <span class="position-absolute top-50 translate-middle-y fs-base ms-4">
                      ...
                      <input type="text" class="form-control form-control-solid fs-8 py-3 ps-10 pe-4" placeholder="GG/AA/YY" id="pw_bilgi_ekle_test_tarihi" />
                    </div>
                  </td>
                </tr>
                <!--end::Row-->
                ...
                <!--begin::Row-->
                <tr>
                  <td><label class="form-label fs-base fw-bolder" for="pw_bilgi_ekle_test_yeri">Test Yeri</label></td>
                  <td>
                  <input type="text" class="form-control form-control-solid fs-8 py-3 ps-10 pe-4" id="pw_bilgi_ekle_test_yeri" />
                  </td>
                </tr>
                <!--end::Row-->
              </tbody>
        ...
        <div class="modal-footer border-0">
          <button type="button" class="btn btn-active-light pw-btn-text-neutral-500 py-3 px-4 me-2 fs-8" data-bs-dismiss="modal">
            Vazgeç
          </button>
          <button class="btn btn-primary py-3 px-4 fs-8">
            Kaydet
          </button>
        </div>
...
<script>
  window.addEventListener('DOMContentLoaded', () => {
    var myDropzone = new Dropzone("#pw_belge_dropzone", {
