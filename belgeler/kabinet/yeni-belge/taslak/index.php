                    ...
                    <div class="table-responsive">
                      <table class="table gx-3 gy-6">
                        <tbody>
                          ...
                          <tr>
                            ...
                            <td>
                              <select id="pw_belge_tipi" class="form-select form-select-solid text-black fs-8 fw-semibold py-3 px-4" data-control="select2" data-placeholder="Seçim yapın" data-hide-search="true" required>
                                <option></option>
                                <option value="0" selected>Sistem</option>
                                <option value="1">Baykuş Arşiv</option>
                                <option value="2">Mantis Arşiv Tipi</option>
                              </select>
                            </td>
                          </tr>
                          <!--end::Row-->
                          ...
                          <!--begin::Row-->
                          <tr>
                            <td><label class="form-label fs-base fw-bolder" for="pw_taslak_adi">Taslak Adı*</label></td>
                            <td>
                              <select id="pw_taslak_adi" class="form-select form-select-solid text-black fs-8 fw-semibold py-3 px-4" data-control="select2" data-placeholder="Seçim yapın" data-hide-search="true" required>
                                <option></option>
                                <option value="0" selected>Sistem</option>
                                <option value="1">Baykuş Arşiv</option>
                                <option value="2">Mantis Arşiv Tipi</option>
                    ...
                    <div class="table-responsive">
                      <table class="table gx-3 gy-2">
                        <tbody>
                          <!--begin::Row-->
                          <tr>
                            <td><label class="form-label fs-base fw-bolder" for="pw_ad_soyad">Ad Soyad</label></td>
                            <td>
                              <input type="text" class="form-control form-control-solid fs-8 py-3 ps-10 pe-4" id="pw_ad_soyad" />
                            </td>
                          </tr>
                          <!--end::Row-->
                          ...
                          <!--begin::Row-->
                          <tr>
                            <td><label class="form-label fs-base fw-bolder" for="pw_mail_adresi">Mail Adresi</label></td>
                            <td>
                              <input type="email" class="form-control form-control-solid fs-8 py-3 ps-10 pe-4" id="pw_mail_adresi" />
                            </td>
                          </tr>
                          <!--end::Row-->
                          ...
                          <!--begin::Row-->
                          <tr>
                            <td><label class="form-label fs-base fw-bolder" for="pw_talep_nedeni">Talep Nedeni</label></td>
                            <td>
                              <input type="email" class="form-control form-control-solid fs-8 py-3 ps-10 pe-4" id="pw_mail_adresi" />
                            </td>
                          </tr>
                          ...
                          <!--begin::Row-->
                          <tr>
                            <td><label class="form-label fs-base fw-bolder" for="pw_talep_tarihi">Talep Tarihi</label></td>
                            <td>
                              <div class="position-relative">
                                ...
                                <input type="text" class="form-control form-control-solid fs-8 py-3 ps-10 pe-4" placeholder="GG/AA/YY" id="pw_talep_tarihi" />
                              </div>
                            </td>
                          </tr>
                          <!--end::Row-->
                          ...
                          <!--begin::Row-->
                          <tr>
                            <td><label class="form-label fs-base fw-bolder" for="pw_il_adi">İl Adı</label></td>
                            <td>
                              <input type="text" class="form-control form-control-solid fs-8 py-3 ps-10 pe-4" id="pw_il_adi" />
                            </td>
                          </tr>
                          <!--end::Row-->
                          ...
                          <!--begin::Row-->
                          <tr>
                            <td><label class="form-label fs-base fw-bolder" for="pw_ilceler">İlçeler</label></td>
                            <td>
                              <input type="text" class="form-control form-control-solid fs-8 py-3 ps-10 pe-4" id="pw_ilceler" />
                            </td>
                          </tr>
                          <!--end::Row-->
                          ...
                          <tr>
                            <td colspan="2">
                              <div class="d-flex flex-column gap-2">
                                <div class="d-flex flex-column flex-sm-row align-items-end justify-between gap-2">
                                  <div class="d-flex flex-column gap-2 flex-fill">
                                    <label class="form-label fs-base fw-bolder">Adres Bilgileri</label>

                                    <!--begin::Button-->
                                    <button type="button" class="btn p-0 fs-9 fs-semibold d-inline-flex align-items-center gap-2" data-bs-toggle="modal" data-bs-target="#adres_ekle">
                                  ...
                                  <button type="button" class="btn btn-outline btn-outline-primary btn-active-light-primary fs-9 px-2 py-1">Excel’e Aktar</button>
                                </div>
          ...
          <div class="table-responsive overflow-x-auto overflow-lg-hidden">
            <table class="table w-min-content w-100 align-middle gy-5 gx-4">
              <tbody>
                ...
                <tr>
                  <td>
                    <label class="form-label fs-base fw-bolder" for="pw_adres_ekle_ilce_adi">İlçe Adı</label>
                  </td>
                  <td>
                    <input type="text" class="form-control form-control-solid fs-8 py-3 ps-10 pe-4" id="pw_adres_ekle_ilce_adi" />
                  </td>
                </tr>
                <!--end::Row-->
                ...
                <!--begin::Row-->
                <tr>
                  <td><label class="form-label fs-base fw-bolder" for="pw_adres_ekle_posta_kodu">Posta Kodu</label></td>
                  <td>
                    <input type="text" class="form-control form-control-solid fs-8 py-3 ps-10 pe-4" id="pw_adres_ekle_posta_kodu" />
                  </td>
                </tr>
                <!--end::Row-->
              </tbody>
