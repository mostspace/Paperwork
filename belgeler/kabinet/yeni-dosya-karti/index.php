  ...
  <div class="app-main flex-column flex-row-fluid" id="kt_app_main">
    ...
    <div class="mb-20 px-6 pb-6">
      ...
      <div class="row g-6">
        ...
        <div class="col-12 col-lg-6">
          <!--begin::Card-->
          <form class="border pw-border-stroke rounded-3 px-8 py-12">
            <!--begin::Table-->
            <div class="table-responsive">
              <table class="table gx-4 gy-3">
                <tbody>
                  <!--begin::Row-->
                  <tr>
                    <td><label class="form-label fs-base fw-bolder" for="pw_klasor_adi">Klasör Adı*</label></td>
                    <td>
                      <select id="pw_klasor_adi" class="form-select form-select-solid text-black fs-8 fw-semibold py-3 px-4" data-control="select2" data-placeholder="Seçim yapın" required>
                        <option></option>
                  ...
                  <!--begin::Row-->
                  <tr>
                    <td><label class="form-label fs-base fw-bolder">Dosya Kartı</label></td>
                    <td>
                      <span class="pw-text-neutral-500 fs-8 fw-semibold">Daikin Kabineti</span>
                    </td>
                  </tr>
                  <!--end::Row-->
                  ...
                  <!--begin::Row-->
                  <tr>
                    <td><label class="form-label fs-base fw-bolder" for="pw_anne_adi">Anne Adı</label></td>
                    <td>
                      <input type="text" class="form-control form-control-solid fs-8 py-3 px-4" id="pw_anne_adi" />
                    </td>
                  </tr>
                  <!--end::Row-->
                  ...
                  <!--begin::Row-->
                  <tr>
                    <td><label class="form-label fs-base fw-bolder" for="pw_baba_adi">Baba Adı</label></td>
                    <td>
                      <input type="text" class="form-control form-control-solid fs-8 py-3 px-4" id="pw_baba_adi" />
                    </td>
                  </tr>
                  <!--end::Row-->
                  ...
                  <tr>
                    <td colspan="2">
                      <div class="d-flex align-items-center justify-content-end mt-4 gap-3">
                        ...
                        <button id="toastBtn" type="button" class="btn btn-primary fs-8 py-3 px-6">
                          Kaydet
                        </button>
                      </div>
                    </td>
...
<script>
  window.addEventListener('DOMContentLoaded', () => {
    ...
    btn.addEventListener('click', () => {
      ...
      toastr.success("Belge başarıyla kaydedildi.");
    })
  })
</script>
<!--end::Toast script-->
