    ...
    <div class="mb-20 px-6 pb-6">
      ...
      <div class="row g-6">
        ...
        <div class="col-12 col-lg-6 d-flex flex-column">
          ...
          <!--begin::Card-->
          <div class="d-flex flex-column justify-content-between flex-fill border pw-border-stroke rounded-3 px-7 py-6">
            <!--begin::Connection-->
            <div class="d-flex flex-column mb-10">
              ...
              <!--begin::Item-->
              <div class="d-flex align-items-center gap-3 p-3 pw-bg-success-100">
                <!--begin::Icon-->
                <span>
                  <i class="fa-solid fa-loader fs-6 pw-text-success-500"></i>
                </span>
                <!--end::Icon-->

                <!--begin::Label-->
                <span class="fs-8 pw-text-neutral-800 fw-semibold">
                PaperWorkTray’e bağlanıldı.
                </span>
                <!--end::Label-->
              </div>
              <!--end::Item-->
