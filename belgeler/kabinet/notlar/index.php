    ...
    <div class="mb-20 px-6 pb-6">
      ...
      <div class="row g-6">
        ...
        <div class="col-12 col-lg-6 d-flex flex-column">
          ...
          <!--begin::Card-->
          <div class="d-flex flex-column justify-content-between flex-fill border pw-border-stroke rounded-0.25rem">
            <!--begin::Notes-->
            <div class="d-flex flex-column gap-4 p-5">
              ...
              <div class="d-flex align-items-center justify-content-end gap-3">
                ...
                <div class="d-flex flex-column gap-1 text-end">
                  ...
                  <span class="pw-text-neutral-300 fs-9 fw-semibold">Test Uzamnı</span>
                </div>
                <!--end::Label-->

                <!--begin::Avatar-->
                <div class="d-flex align-items-center justify-content-center w-35px h-35px rounded-pill border pw-border-primary-200 pw-text-primary-500 pw-bg-primary-100 fs-base fw-bolder">U</div>
                <!--end::Avatar-->
              </div>
              <!--end::Header-->

              <!--begin::Item-->
              <div class="d-flex align-items-center justify-content-end gap-4 mw-75 ms-auto">
                <span class="pw-text-neutral-300 fs-9 flex-shrink-0">1 dk</span>

                <i class="fa-solid fa-xmark fs-3 pw-text-danger-500 flex-shrink-0"></i>

                <!--begin::Note-->
                <div class="text-black fs-8 py-4 px-3 rounded pw-bg-primary-100">
            ...
            <div class="d-flex flex-column">
              <!--begin::Editor-->
              <div id="leaveNote"></div>
              <!--end::Editor-->

              <!--begin::Send button-->
              <div class="d-flex justify-content-end py-3 px-5 text-end border-top pw-border-stroke">
                <button type="button" class="btn btn-primary py-3 px-5 fs-7 fw-bold rounded-end-0 h-45px text-center align-middle">
                  Gönder
                </button>

                <!--begin::Toggle-->
                <button type="button" class="btn btn-primary py-3 px-2 fs-8 rounded-start-0 h-45px text-center align-middle border-start pw-border-primary-700" data-kt-menu-trigger="click" data-kt-menu-placement="top-end" data-kt-menu-offset="0,5">
                  <span class="svg-icon rotate-180 m-0">
                    <i class="fa-solid fa-chevron-down fs-8 me-0"></i>
                  </span>
                </button>
                <!--end::Toggle-->

                <!--begin::Dropdown-->
                <div class="menu menu-sub menu-sub-dropdown w-200px" data-kt-menu="true" id="pw_gonder_dropdown">
                  <div class="d-flex flex-column">
                    <!--begin::Item-->
                    <button type="button" class="btn btn-active-light-secondary pw-text-neutral-800 fw-semibold fs-7 text-start py-3 px-4 rounded-0">Item 1</button>
                    <!--end::Item-->

                    <!--begin::Item-->
                    <button type="button" class="btn btn-active-light-secondary pw-text-neutral-800 fw-semibold fs-7 text-start py-3 px-4 rounded-0">Item 2</button>
                    <!--end::Item-->

                    <!--begin::Item-->
                    <button type="button" class="btn btn-active-light-secondary pw-text-neutral-800 fw-semibold fs-7 text-start py-3 px-4 rounded-0">Item 3</button>
                    <!--end::Item-->
                  </div>
                </div>
                <!--end::Dropdown-->
...
<script>
  window.addEventListener('DOMContentLoaded', () => {
    ClassicEditor
      .create(document.querySelector('#leaveNote'), {
        toolbar: {
          items: [
            'heading', '|',
