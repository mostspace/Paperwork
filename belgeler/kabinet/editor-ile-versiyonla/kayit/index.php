    ...
    <div class="mb-20 px-6 pb-6">
      ...
      <div class="row g-6">
        ...
        <div class="col-12 col-lg-6 d-flex flex-column">
          <!--begin::Back button-->
          <div>
            <a href="/belgeler/kabinet/editor-ile-versiyonla/" class="btn btn-color-primary fs-7 p-0 fw-semibold mb-4">
          ...
          <div class="table-responsive">
            <table class="table table-row-bordered border pw-table-border-gray pw-dark-bg-table table-rounded align-middle w-max-content min-w-100 fw-semibold fs-8 pw-text-neutral-700 gs-6 gy-4 gx-6">
              <thead>
              ...
              <tbody>
                <!--begin::Row-->
                <tr>
                  <td>Akış Yöneticisi</td>
                  <td>UIDesk</td>
                  <td>13:12:32</td>
                  <td>3.69 Kb</td>
                  <td>3.66 Kb</td>
                  <td class="text-end" align="right">
                    <button type="button" class="btn btn-icon pw-btn-bg-neutral-100 btn-text-primary pw-btn-hover-bg-neutral-200 w-30px h-30px rounded-0.5" data-bs-toggle="modal" data-bs-target="#versiyon">
                      <i class="fa-solid fa-eye fs-7 text-primary"></i>
                    </button>

                    <a href="/belgeler/kabinet/editor-ile-versiyonla/" class="btn btn-icon pw-btn-bg-neutral-100 btn-text-primary pw-btn-hover-bg-neutral-200 w-30px h-30px rounded-0.5" data-bs-toggle="tooltip" data-bs-custom-class="tooltip-inverse" data-bs-placement="bottom" title="Bu versiyona dön">
                      <i class="fa-solid fa-arrow-rotate-left fs-7 text-primary"></i>
                    </a>
                  </td>
                </tr>
                <!--end::Row-->
...
<!--begin::Modal-->
<div class="modal fade" tabindex="-1" id="versiyon" aria-hidden="true">
  <div class="modal-dialog modal-dialog-centered modal-lg mw-650px">
    <div class="modal-content">
      <div class="modal-header">
        <h3 class="modal-title">Versiyon 1.0</h3>
      ...
      <!--begin::Sub header-->
      <div class="d-flex align-items-center justify-content-between gap-4 border-bottom py-3 px-5 pw-border-stroke">
        <!--begin::Left side-->
        <div class="d-flex align-items-center gap-2">
          <!--begin::Item-->
          <button type="button" class="btn p-0 rounded-0">
            <i class="fa-solid fa-print pw-text-neutral-300"></i>
          </button>
          <!--end::Item-->

          <!--begin::Separator-->
          <div class="separator pw-bg-neutral-300 h-20px w-1px"></div>
          <!--end::Separator-->

          <!--begin::Item-->
          <button type="button" class="btn p-0 rounded-0">
            <i class="fa-solid fa-download pw-text-neutral-300"></i>
          </button>
          <!--end::Item-->
          ...
          <!--begin::Item-->
          <button type="button" class="btn p-0 rounded-0 mx-1">
            <i class="fa-solid fa-file-magnifying-glass pw-text-neutral-300"></i>
          </button>
          <!--end::Item-->

          <!--begin::Item-->
          <button type="button" class="btn p-0 rounded-0 me-1">
            <i class="fa-solid fa-arrows-left-right pw-text-neutral-300"></i>
          </button>
          <!--end::Item-->
          ...
          <!--begin::Item-->
          <button type="button" class="btn p-0 rounded-0 mx-1">
            <i class="fa-solid fa-compress pw-text-neutral-300"></i>
          </button>
          <!--end::Item-->

          <!--begin::Item-->
          <button type="button" class="btn p-0 rounded-0 me-1">
            <i class="fa-solid fa-magnifying-glass-plus pw-text-neutral-300"></i>
          </button>
          <!--end::Item-->
          ...
          <!--begin::Item-->
          <button type="button" class="btn p-0 rounded-0 mx-1">
            <i class="fa-solid fa-magnifying-glass-minus pw-text-neutral-300"></i>
          </button>
          <!--end::Item-->

          <!--begin::Item-->
          <button type="button" class="btn p-0 rounded-0 me-1">
            <i class="fa-solid fa-arrow-rotate-left pw-text-neutral-300"></i>
          </button>
          <!--end::Item-->

          <!--begin::Item-->
          <button type="button" class="btn p-0 rounded-0 me-1">
            <i class="fa-solid fa-arrow-rotate-right pw-text-neutral-300"></i>
          </button>
          <!--end::Item-->
        </div>
        <!--end::Left side-->
        ...
        <div class="d-flex align-items-center gap-4">
          ...
          <!--begin::Item-->
          <button type="button" class="btn p-0 rounded-0">
            <i class="fa-solid fa-circle-question pw-text-neutral-300"></i>
          </button>
          <!--end::Item-->
        </div>
        <!--end::Right side-->
