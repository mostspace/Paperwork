    ...
    <div class="mb-20 px-6 pb-6">
      ...
      <div class="row g-6">
        ...
        <div class="col-12 col-lg-6 d-flex flex-column">
          ...
          <!--begin::Card-->
          <form class="px-8 py-6 border pw-border-stroke rounded-3">
            <!--begin::Radio group-->
            <div class="d-flex flex-column gap-4 mb-10">
              <!--begin::Item-->
              <div class="form-check">
                <input class="form-check-input pw-border-primary-500" type="radio" value="" id="pw_mevcut_versiyon" name="pw_option" />
                <label class="form-check-label text-black " for="pw_mevcut_versiyon">
                  Mevcut Versiyon
                </label>
              </div>
              <!--end::Item-->
              ...
              <!--begin::Item-->
              <div class="form-check">
                <input class="form-check-input pw-border-primary-500" type="radio" value="" id="pw_minor_versiyon" name="pw_option" />
                <label class="form-check-label text-black " for="pw_minor_versiyon">
                  Minor Versiyon (x.x.1.0)
                </label>
              </div>
              <!--end::Item-->
              ...
              <!--begin::Item-->
              <div class="form-check">
                <input class="form-check-input pw-border-primary-500" type="radio" value="" id="pw_major_versiyon" name="pw_option" />
                <label class="form-check-label text-black " for="pw_major_versiyon">
                  Majör Versiyon (1.1.x.x)
                </label>
              </div>
              <!--end::Item-->
            </div>
            ...
            <!--begin::Aciklama editor-->
            <div id="pw_aciklama"></div>
            <!--end::Aciklama editor-->

            <!--begin::Dropzone-->
            <div class="dropzone mt-5" id="pw_belge_dropzone">
              <!--begin::Message-->
            ...
            <div class="d-flex align-items-center justify-content-end mt-10 gap-3">
              ...
              <a href="/belgeler/kabinet/editor-ile-versiyonla/kayit/" class="btn btn-primary fs-8 py-3 px-6">
                Tamam
              </a>
            </div>
            <!--end::Form actions-->
