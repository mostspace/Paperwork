    ...
    <div class="mb-20 px-6 pb-6">
      ...
      <div class="row g-6">
        ...
        <div class="col-12 col-lg-6 d-flex flex-column">
          <!--begin::Back button-->
          <div>
            <a href="/belgeler/kabinet/sohbet/" class="btn btn-color-primary fs-7 p-0 fw-semibold mb-4">
          ...
          <!--begin::Card-->
          <div class="d-flex flex-column flex-fill border pw-border-stroke rounded-0.25rem overflow-x-auto">
            <!--begin::Header-->
            <div class="py-4 px-3 border-bottom pw-border-stroke">
              <!--begin::Title-->
              <h3 class="text-black fs-7 fw-bold">Sohbet Listesi</h3>
              <!--end::Title-->
            </div>
            <!--end::Header-->
            ...
            <div class="flex-fill">
              ...
              <div class="row g-0">
                <!--begin::Item-->
                <div class="col-12 py-3 px-4 border-bottom pw-border-stroke">
                  <!--begin::Wrapper-->
                  <div class="row g-0">
                    <div class="col-4">
                      <div class="d-flex align-items-center gap-4">
                        <!--begin::Avatar-->
                        <div class="position-relative d-flex align-items-center justify-content-center w-35px h-35px rounded-pill pw-text-primary-500 pw-bg-primary-100 fs-4 fw-bold">
                          U
                        ...
                        <!--begin::Label-->
                        <div class="d-flex flex-column">
                          <span class="pw-text-neutral-800 fs-8 fw-bolder">UIDesk</span>
                          <span class="pw-text-neutral-300 fs-9 fw-semibold">Art Director at Novica Co.</span>
                        </div>
                        <!--end::Label-->

                        <!--begin::Separator-->
                        <div class="d-flex align-items-center justify-content-center flex-fill">
                          <div class="h-35px w-1px pw-bg-neutral-200"></div>
                        </div>
                        <!--end::Separator-->
                      </div>
                    </div>
                    <div class="col-8 d-flex align-items-center">
                      <span class="pw-text-neutral-800 fs-8 fw-semibold">Test</span>
                    </div>
                  </div>
                  <!--end::Wrapper-->
                </div>
                ...
                <div class="col-12 py-3 px-4 border-bottom pw-border-stroke">
                  ...
                  <div class="row g-0">
                    ...
                    <div class="col-8 d-flex align-items-center">
                      <span class="pw-text-neutral-800 fs-8 fw-semibold">Duyuru</span>
                    </div>
                  </div>
                  <!--end::Wrapper-->
                </div>
              ...
              <div class="p-5 text-end">
                <button type="button" class="btn btn-primary px-5 py-3 fs-8 fw-semibold rounded-0.25rem">Ekle</button>
              </div>
              <!--end::Button-->
            </div>
            <!--end::Body-->
            ...
            <div class="p-5">
              <button type="button" class="btn p-0">
                <i class="fa-solid fa-paperclip fs-1 pw-text-neutral-300"></i>
              </button>
            </div>
            <!--end::Footer-->
          </div>
