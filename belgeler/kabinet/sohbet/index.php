  ...
  <div class="app-main flex-column flex-row-fluid" id="kt_app_main">
    ...
    <div class="mb-20 px-6 pb-6">
      ...
      <div class="row g-6">
        ...
        <div class="col-12 col-lg-6">
          <!--begin::Back button-->
          <a href="/belgeler/kabinet/" class="btn btn-color-primary fs-7 fw-semibold mb-4">
          ...
          <!--begin::Card-->
          <div class="border pw-border-stroke rounded px-5 py-8">
            <!--begin::Form-->
            <form>
              <!--begin::Table-->
              <table class="table">
                ...
                <tr>
                  <td>
                    <label class="form-label fs-8 fw-bolder" for="pw_shobet_konu">Konu*</label>
                  </td>
                  <td>
                    <input type="text" class="form-control form-control-solid px-4 py-3 fs-8" id="pw_shobet_konu" />
                  </td>
                </tr>
                <!--end::Row-->
            ...
            <a href="/belgeler/kabinet/sohbet/chat/" class="btn btn-primary fs-8 py-3 px-6">
              Chat
            </a>
          </div>
          <!--end::Card-->
