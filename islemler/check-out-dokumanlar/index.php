  ...
  <div class="app-main flex-column flex-row-fluid" id="kt_app_main">
    ...
    <div class="row">
      <div class="col">
          ...
          <div id="kt_app_toolbar_container" class="container-fluid d-flex flex-stack p-0">
            ...
            <div class="page-title d-flex flex-column justify-content-center flex-wrap me-3">
              ...
              <ul class="breadcrumb breadcrumb-separatorless fw-semibold fs-9 mt-0 mb-3">
                ...
                <!--end::Item-->
                <!--begin::Item-->
                <li class="breadcrumb-item active"> Check Out Dokümanlar</li>
                <!--end::Item-->
              </ul>
              <!--end::Breadcrumb-->
              <!--begin::Title-->
        ...
        <!--begin::Content -->
        <div class="mb-20">
          <!--begin::Check Out Dokümanlar tablosu-->
              ...
              <tbody>
                ...
                <tr class="fw-medium pw-text-neutral-700 fs-9 hover-pw-bg-primary-300">
                  <td class="py-6 d-flex">
                    <i class="fa-solid fa-lock-keyhole px-2 pw-text-primary cursor-pointer" data-kt-menu-trigger="click" data-kt-menu-placement="bottom-start" data-kt-menu-offset="0,5" data-bs-toggle="tooltip" data-bs-custom-class="tooltip-inverse" data-bs-placement="left" title="Kilidi Kaldır"></i>
                    ONS_rule_engine_01
                    <!--begin::dropdown-->
                    <div class="menu menu-sub menu-sub-dropdown " data-kt-menu="true" id="pw_belgeler_kabinet">
                      <div class="d-flex flex-column">
                        <!--begin::Item-->
                        <div class="p-5">
                          <p class="pw-text-neutral-800 fw-semibold fs-7 text-start py-3 px-4 rounded-0">Bu kilidi kaldırmak istiyor musunuz?</p>
          ...
          <!--end::Check Out Dokümanlar tablosu-->
