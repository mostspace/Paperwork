          ...
          <div id="kt_app_toolbar_container" class="container-fluid d-flex flex-stack p-0">
            ...
            <div class="page-title d-flex flex-column justify-content-center flex-wrap me-3">
              ...
              <ul class="breadcrumb breadcrumb-separatorless fw-semibold fs-9 mt-0 mb-3">
                ...
                <!--end::Item-->
                <!--begin::Item-->
                <li class="breadcrumb-item active">Görüntülenmiş Belgeler</li>
                <!--end::Item-->
              </ul>
              <!--end::Breadcrumb-->
              <!--begin::Title-->
            ...
            <div class="tab-pane fade active show" id="pw_tab_pane_veri" role="tabpanel">
                ...
                <table class="table table-row-bordered border pw-dark-bg-table pw-table-border-gray table-rounded w-max-content min-w-100">
                  ...
                  <thead>
                    <tr class="fw-semibold fs-8 pw-text-neutral-700 pw-bg-neutral-100">
                      ...
                      <th class="py-3 px-9">İçerik Boyutu</th>
                      <th class="py-3 px-9">Dosya Yolu</th>
                    </tr>
                  </thead>
                  <!--end::Table head-->
                  ...
                  <tbody>
                    ...
                    <tr class="fw-medium pw-text-neutral-700 fs-9">
                      ...
                      <td class="py-6 px-9">Owl Paperwork</td>
                      <td class="py-6 px-9">BT Active Add</td>
                      <td class="py-6 px-9">Microsoft Word Open XML Document</td>
                      <td class="py-6 px-9">4.87 Kb</td>
                    ...
                    <tr class="fw-medium pw-text-neutral-700 fs-9">
                      ...
                      <td class="py-6 px-9">Microsoft Word Open XML Document</td>
                      <td class="py-6 px-9">4.87 Kb</td>
                      <td class="py-6 px-9">K Active Additional/Eklenti/G..</td>
                    </tr>
                    <!--end::Row-->
                    ...
                    <tr class="fw-medium pw-text-neutral-700 fs-9">
                      ...
                      <td class="py-6 px-9">Microsoft Word Open XML Document</td>
                      <td class="py-6 px-9">4.87 Kb</td>
                      <td class="py-6 px-9">D Active Folders</td>
                    </tr>
                    <!--end::Row-->
              ...
              <div class="d-flex flex-column-reverse flex-sm-row align-items-center align-items-sm-end justify-content-center justify-content-sm-between gap-8 gap-sm-4 my-10">
                ...
                <div class="d-flex flex-column flex-sm-row flex-wrap align-items-center gap-2 gap-sm-6 gap-md-9 fw-medium text-primary fs-8 justify-content-center justify-content-sm-start w-100">
                  <span>Toplam: 2.400 Adet</span>
                  <span>Boyut: 10.73 Gb</span>
                </div>
                <!--end::Information-->
                <!--begin::Pagination-->
                <ul class="pagination flex-nowrap flex-shrink-0">
                  <!--begin::Pagination item previous-->
                  <li class="page-item previous disabled"><a href="/sistem-raporlari/dokuman-yonetimi/goruntulenmis-belgeler#" class="page-link pw-min-w-32px h-32px fs-8"><i class="previous"></i></a></li>
                  <!--end::Pagination item previous-->

                  <!--begin::Pagination-item-->
                  <li class="page-item active">
                    <a href="/sistem-raporlari/dokuman-yonetimi/goruntulenmis-belgeler#" class="page-link pw-min-w-32px h-32px fs-8">1</a>
                  </li>
                  <!--end::Pagination item-->

                  <!--begin::Pagination item-->
                  <li class="page-item">
                    <a href="/sistem-raporlari/dokuman-yonetimi/goruntulenmis-belgeler#" class="page-link pw-min-w-32px h-32px fs-8">2</a>
                  </li>
                  <!--end::Pagination item-->

                  <!--begin::Pagination item-->
                  <li class="page-item ">
                    <a href="/sistem-raporlari/dokuman-yonetimi/goruntulenmis-belgeler#" class="page-link pw-min-w-32px h-32px fs-8">3</a>
                  </li>
                  <!--end::Pagination item-->

                  <!--begin::Pagination item-->
                  <li class="page-item ">
                    <a href="/sistem-raporlari/dokuman-yonetimi/goruntulenmis-belgeler#" class="page-link pw-min-w-32px h-32px fs-8">4</a>
                  </li>
                  <!--end::Pagination item-->

                  <!--begin::Pagination item-->
                  <li class="page-item ">
                    <a href="/sistem-raporlari/dokuman-yonetimi/goruntulenmis-belgeler#" class="page-link pw-min-w-32px h-32px fs-8">5</a>
                  </li>
                  <!--end::Pagination item-->

                  <!--begin::Pagination item-->
                  <li class="page-item ">
                    <a href="/sistem-raporlari/dokuman-yonetimi/goruntulenmis-belgeler#" class="page-link pw-min-w-32px h-32px fs-8">6</a>
                  </li>
                  <!--end::Pagination item-->

                  <!--begin::Pagination item-->
                  <li class="page-item next">
                    <a href="/sistem-raporlari/dokuman-yonetimi/goruntulenmis-belgeler#" class="page-link pw-min-w-32px h-32px fs-8"><i class="next"></i></a>
                  </li>
                  <!--end::Pagination item-->
                </ul>
                <!--end::Pagination-->
