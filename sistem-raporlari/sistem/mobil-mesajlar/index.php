          ...
          <div id="kt_app_toolbar_container" class="container-fluid d-flex flex-stack p-0">
            ...
            <div class="page-title d-flex flex-column justify-content-center flex-wrap me-3">
              ...
              <ul class="breadcrumb breadcrumb-separatorless fw-semibold fs-9 mt-0 mb-3">
                ...
                <!--end::Item-->
                <!--begin::Item-->
                <li class="breadcrumb-item active">Mobil Mesajlar</li>
                <!--end::Item-->
              </ul>
              <!--end::Breadcrumb-->
              <!--begin::Title-->
                ...
                <table class="table w-min-content w-100">
                  <tbody>
                    ...
                    <!--end::Row-->
                     ...
                     <tr>
                      <td>
                        <label class="form-label fs-7 fw-bolder" for="pw_mesaj_tipi">Mesaj Tipi</label>
                      </td>
                      <td>
                        <select class="form-select form-select-solid fs-8 py-3 px-4" data-control="select2" data-placeholder="Seçim Yapın" id="pw_mesaj_tipi" name="pw_mesaj_tipi">
                          <option></option>
                          <option value="1">Option 1</option>
                          <option value="2">Option 2</option>
                        </select>
                    ...
                    <!--end::Row-->
                       ...
                       <tr>
                      <td>
                        <label class="form-label fs-7 fw-bolder" for="pw_sonucu">Sonucu</label>
                      </td>
                      <td>
                        <select class="form-select form-select-solid fs-8 py-3 px-4" data-control="select2" data-placeholder="Seçim Yapın" id="pw_sonucu" name="pw_sonucu">
                          <option></option>
                          <option value="1">Option 1</option>
                          <option value="2">Option 2</option>
                        </select>
            ...
            <table class="table table-row-bordered border pw-dark-bg-table pw-table-border-gray table-rounded align-middle w-max-content min-w-100">
              ...
              <thead>
                <tr class="fw-semibold fs-8 pw-text-neutral-700 pw-bg-neutral-100">
                  ...
                  <th class="py-3 px-9">Kullanıcı IP</th>
                  <th class="py-3 px-9">Uygulama</th>
                  <th class="py-3 px-9">Süre</th>
                </tr>
              </thead>
              <!--end::Table head-->
