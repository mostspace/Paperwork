          ...
          <div id="kt_app_toolbar_container" class="container-fluid d-flex flex-stack p-0">
            ...
            <div class="page-title d-flex flex-column justify-content-center flex-wrap me-3">
              ...
              <ul class="breadcrumb breadcrumb-separatorless fw-semibold fs-9 mt-0 mb-3">
                ...
                <!--end::Item-->
                <!--begin::Item-->
                <li class="breadcrumb-item active">Belge İndeksi</li>
                <!--end::Item-->
              </ul>
              <!--end::Breadcrumb-->
              <!--begin::Title-->
            ...
            <table class="table table-row-bordered border pw-dark-bg-table pw-table-border-gray table-rounded align-middle w-max-content min-w-100">
              ...
              <thead>
                <tr class="fw-semibold fs-8 pw-text-neutral-700 pw-bg-neutral-100">
                  ...
                  <th class="py-3 px-9">Indeks Tarihi</th>
                  <th class="py-3 px-9">Durum</th>
                  <th class="py-3 px-9">Hata</th>
                </tr>
              </thead>
              <!--end::Table head-->
              ...
              <tbody>
                ...
                <tr class="fw-medium pw-text-neutral-700 fs-9">
                  <td class="py-6 px-9">
                    <!--begin::Checkbox-->
                    <div class="form-check d-flex align-items-center gap-2 mb-0">
                      <input class="form-check-input" type="checkbox" value="" id="pw_row_date_1">
                      <label for="pw_row_date_1">21.11.2022</label>
                    </div>
                    <!--end::Checkbox-->
                  </td>
...
<!--begin::Contextmenu-->
<div id="pw_contextmenu" class="position-absolute pw-contextmenu" style="top: 570px; left:500px;">
  <!--begin::Contextmenu item-->
  <button class="btn btn-color-white fs-9 d-flex align-items-center gap-2 p-3 border-bottom rounded-0 pw-border-excelstroke">
    <span class="icon"><i class="fa-solid fa-table-cells fs-9"></i></span>
    Excel’e aktar
  </button>
  <!--end::Contextmenu item-->

  <!--begin::Contextmenu item-->
  <button class="btn btn-color-white fs-9 d-flex align-items-center gap-2 p-3 rounded-0">
    <span class="icon"><i class="fa-solid fa-clock-rotate-left fs-9"></i></span>
    Tekrar dene
  </button>
  <!--end::Contextmenu item-->
</div>
