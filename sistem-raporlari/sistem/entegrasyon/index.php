                ...
                <table class="table w-min-content w-100">
                  <tbody>
                    ...
                    <!--end::Row-->
                     ...
                     <tr>
                      <td>
                        <label class="form-label fs-7 fw-bolder" for="pw_sahibi">Sahibi</label>
                      </td>
                      <td>
                        <select class="form-select form-select-solid fs-8 py-3 px-4" data-control="select2" data-placeholder="Seçim Yapın" id="pw_Sahibi" name="pw_Sahibi">
                          <option></option>
                          <option value="1">Option 1</option>
                          <option value="2">Option 2</option>
                        </select>
                    ...
                    <tr>
                      <td>
                        <label class="form-label fs-7 fw-bolder" for="pw_icerik">İçerik</label>
                      </td>
                      <td>
                        <select class="form-select form-select-solid fs-8 py-3 px-4" data-control="select2" data-placeholder="Seçim Yapın" id="pw_icerik" name="pw_icerik">
                          <option></option>
                          <option value="1">Option 1</option>
                          <option value="2">Option 2</option>
                        </select>
                    ...
                    <!--end::Row-->
                      ...
                      <td>
                        <select class="form-select form-select-solid fs-8 py-3 px-4" data-control="select2" data-placeholder="Seçim Yapın" id="pw_durum" name="pw_durum">
                          <option></option>
                          <option value="1">Option 1</option>
                          <option value="2">Option 2</option>
                        </select>
