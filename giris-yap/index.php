...
<body id="kt_app_body" data-kt-app-layout="light-sidebar" data-kt-app-header-fixed="true" data-kt-app-sidebar-enabled="true" data-kt-app-sidebar-fixed="true" data-kt-app-sidebar-hoverable="true" data-kt-app-sidebar-push-header="true" data-kt-app-sidebar-push-toolbar="true" data-kt-app-sidebar-push-footer="true" data-kt-app-toolbar-enabled="true" class="app-default">
  ...
  <div class="row g-0 h-100">
    ...
    <div class="position-relative col d-flex flex-column align-items-center justify-content-center">
      ...
      <!--begin::Form-->
      <form class="d-flex flex-column gap-6 mw-400px w-100 p-4">
        <!--begin::Header-->
        <div class="d-flex flex-column justfiy-content-center text-center">
          <!--begin::Title-->
          <h1 class="pw-text-primary-900 fs-2x fw-bold font-poppins mb-2">Giriş Yap</h1>
          <!--end::Title-->

          <!--begin::Text-->
          <span class="pw-text-neutral-700 fs-base">Hoş geldiniz! Hesabınıza giriş yapabilirsiniz.</span>
          <!--end::Text-->
        </div>
        <!--end::Header-->
        ...
        <div class="d-flex flex-column">
          <input type="email" class="form-control mb-4" placeholder="E-posta" />
          <input type="password" class="form-control mb-4" placeholder="Şifre" />

          <div class="d-flex flex-wrap justify-content-between gap-2">
            <!--begin::Checkbox-->
            <div class="form-check pw-form-check-rounded-sm pw-form-check-sm">
              <input class="form-check-input" type="checkbox" value="beni_hatirla" id="pw_beni_hatirla">
              <label class="form-check-label pw-text-neutral-700 fw-medium" for="pw_beni_hatirla">
                Beni hatırla
              </label>
            </div>
            <!--end::Checkbox-->

            <a href="javascript:void(0)" class="btn p-0 btn-link pw-text-primary-500 fs-8">Şifremi unuttum</a>
          </div>

          <div class="my-5">recaptcha area</div>

          <a href="/giris-yap/auth" class="btn btn-primary py-3 px-5 fs-7 fw-semibold">Giriş Yap</a>

          <span class="pw-text-neutral-500 fs-8 text-center mt-10">2011-2023© PaperWork. Tüm hakları saklıdır.</span>
        </div>
        <!--end::Body-->
      </form>
      <!--end::Form-->
