...
<div class="app-wrapper flex-column flex-row-fluid" id="kt_app_wrapper">
    ...
    <div class="app-main flex-column flex-row-fluid" id="kt_app_main">
        ...
        <div class="d-flex align-items-center gap-5 border-top border-bottom pw-border-neutral-200 px-6 py-2 my-4">
            ...
            <a href="/tanimlamalar/surec-yonetimi/takvim-tanimlari/yeni-ekle/" type="button" class="btn p-0">
                <span class="btn p-0 fs-9 fs-semibold d-inline-flex align-items-center gap-2" data-bs-toggle="tooltip"
                    data-bs-custom-class="tooltip-inverse" data-bs-placement="bottom" title="Yeni Takvim Ekle">
        ...
        <div class="col-12 col-md-11 mb-20 px-6 pb-6">
            ...
            <div class="table-responsive overflow-x-auto rounded">
                <!--begin::Table-Light-->
                <table
                    class="table table-row-bordered border pw-table-border-gray table-rounded align-middle w-max-content min-w-100 gy-2 gx-9 gs-9">
                    <thead>
                        <tr class="fw-semibold fs-8 pw-text-neutral-700 pw-bg-neutral-100">
                            <th class="py-3">TAKVİM ADI</th>
                            <th class="py-3"></th>
                        </tr>
                    </thead>
                    <tbody>
                        ...
                        <tr class="fw-medium pw-text-neutral-700 fs-8">
                            ...
                            <td align="right">
                                <!--end::Menu wrapper-->
                                <a href="tanimlamalar/surec-yonetimi/takvim-tanimlari/#"
                                    class="btn btn-icon pw-btn-bg-neutral-100 btn-text-primary pw-btn-hover-bg-neutral-200 w-30px h-30px rounded-0.5" data-bs-toggle="modal" data-bs-target="#yeni-takvim-ekle">
                                ...
                                <a href="tanimlamalar/surec-yonetimi/takvim-tanimlari/#"
                                    ...
                                    data-bs-toggle="modal" data-bs-target="#arastırma-merkezi-arsiv">
...
<!--begin::Modal-->
<div class="modal fade" tabindex="-1" id="yeni-takvim-ekle">
    <div class="modal-dialog modal-dialog-centered modal-xl">
        <div class="modal-content">
            <div class="modal-header">
                <h2 class="modal-title">2021 Takvimi</h2>
            </div>
            ...
            <div class="modal-body">
                ...
                <ul class="nav nav-tabs nav-line-tabs mb-5 fs-6" role="tablist">
                    ...
                    <li class="nav-item" role="presentation">
                        <a class="nav-link fw-medium py-1 px-4 me-0 active" data-bs-toggle="tab"
                            href="#pw_tab_pane_detaylar" aria-selected="true" role="tab">
                            Detaylar
                        </a>
                    </li>
                    <!--end::Nav item-->
                    ...
                    <!--begin::Nav item-->
                    <li class="nav-item" role="presentation">
                        <a class="nav-link fw-medium py-1 px-4 me-0" data-bs-toggle="tab" href="#pw_tab_pane_tarihce"
                ...
                <div class="tab-content" id="eFaturaTabContent">
                    ...
                    <div class="tab-pane fade show active" id="pw_tab_pane_detaylar" role="tabpanel">
                        <form>
                            <div class="table-responsive">
                                <table class="table">
                                    <tbody>
                                        ...
                                        <tr>
                                            <td>
                                                <label class="fs-8 fw-bolder" for="organizasyon-adi">Takvim Adı</label>
                                            </td>
                                            <td>
                                                <label class="fs-8 fw-bold">2021 Takvimi</label>
                                            </td>
                                        </tr>
                                        <!--end::Row-->
                                        ...
                                        <tr>
                                            <td>
                                                <label class="fs-8 fw-bolder" for="kullanildigi-akislar">Çalışma
                                                    Saatleri</label>
                                            </td>
                                            <td>
                                                <div class="d-flex gap-3">
                                                    <div>
                                                        <label class="fw-semibold mb-2">Öğleden Sonra</label>
                                                        <div class="input-group input-group-solid mb-5">
                                                            <input type="text" class="form-control fs-8"
                                                                value="13:00 - 16:00" placeholder=""
                                                                aria-label="Username" />
                                                            <span class="input-group-text"><i
                                                                    class="fa-solid fa-clock fs-7 pw-text-primary-300"></i></span>
                                                        </div>
                                                    </div>
                                                    <div>
                                                        <label class="fw-semibold mb-2">Öğleden Sonra</label>
                            ...
                            <tr>
                                <td>
                                    <label class="fs-8 fw-bolder" for="aciklama">Çalışma Günleri</label>
                                </td>
                                <td>
                                    ...
                                    <div class="py-5">
                                        ...
                                        <table class="table table-row-dashed table-row-gray-300">
                                                <thead>
                                                    <tr class="fw-semibold fs-9 text-gray-800 pw-bg-table rounded">
                                                ...
                                                <tbody>
                                                    <tr>
                                                      <td>Öğleden Önce</td>
                                                      <td  align="center"><i class="fa-solid fa-check fs-7 pw-text-success-500"></i></td>
                                                      <td  align="center"><i class="fa-solid fa-check fs-7 pw-text-success-500"></i></td>
                                                      <td  align="center"><i class="fa-solid fa-check fs-7 pw-text-success-500"></i></td>
                                                      <td  align="center"><i class="fa-solid fa-check fs-7 pw-text-success-500"></i></td>
                                                      <td  align="center"><i class="fa-solid fa-check fs-7 pw-text-success-500"></i></td>
                    ...
                    <div class="d-flex flex-column gap-6">
                        ...
                        <a href="#" class="d-flex align-items-center gap-3">
                            ...
                            <div class="d-flex flex-column gap-1">
                                <div class="fs-9 pw-text-neutral-800 fw-medium"><b>BT Eyüp</b> isimli belge taslağı
                                    <b>Eyüp Tarık Doğan</b> tarafından eklendi.
                                </div>
                        ...
                        <a href="#" class="d-flex align-items-center gap-3">
                            ...
                            <div class="d-flex flex-column gap-1">
                                <div class="fs-9 pw-text-neutral-800 fw-medium"><b>Özlük Dosyaları Belge Taslağı</b>
                                    isimli belge taslağı <b>Eyüp Tarık Doğan</b> tarafından değiştirildi.</div>
                                <div class="d-flex align-items-center gap-1 fs-9 pw-text-neutral-500">
                                    <span>27.02.2023</span>
                                    <span>|</span>
                                    <span>11:39:32</span>
                        ...
                        <a href="#" class="d-flex align-items-center gap-3">
                            ...
                            <div class="d-flex flex-column gap-1">
                                <div class="fs-9 pw-text-neutral-800 fw-medium"><b>ÇORUH PSS İPTAL SÜRECİ HATALI-
                                        İPTAL CEVAP YAZISI</b> isimli belge taslağı <b>Süreyya Borhan</b> tarafından
                                    eklendi.</div>
                                <div class="d-flex align-items-center gap-1 fs-9 pw-text-neutral-500">
                                    <span>27.02.2023</span>
                                    <span>|</span>
                        ...
                        <a href="#" class="d-flex align-items-center gap-3">
                            ...
                            <div class="d-flex flex-column gap-1">
                                <div class="fs-9 pw-text-neutral-800 fw-medium"><b>PSS-Belge Taslağı 2</b> isimli
                                    belge taslağı <b>Remzi Gölgeli</b> tarafından değiştirildi.</div>
                                <div class="d-flex align-items-center gap-1 fs-9 pw-text-neutral-500">
                                    <span>27.02.2023</span>
                                    <span>|</span>
                                    <span>11:39:32</span>
                        ...
                        <a href="#" class="d-flex align-items-center gap-3">
                            ...
                            <div class="d-flex flex-column gap-1">
                                <div class="fs-9 pw-text-neutral-800 fw-medium"><b>Taslak1</b> isimli belge taslağı
                                    <b>Eyüp Tarık Doğan</b> tarafından silindi.
                                </div>
                                <div class="d-flex align-items-center gap-1 fs-9 pw-text-neutral-500">
                                    <span>27.02.2023</span>
                                    <span>|</span>
