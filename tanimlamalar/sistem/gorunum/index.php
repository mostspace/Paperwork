                ...
                <tbody>
                  ...
                  <tr>
                    ...
                    <td>
                      ...
                      <input type="color" class="pw-color-picker" value="#3699FF" id="pw_bg_renk" name="pw_bg_renk" />
                      <label class="icon pw-shadow-sm" for="pw_bg_renk" data-kt-image-input-action="change" data-bs-toggle="tooltip" data-bs-dismiss="click" title="Renk değiştir">
                        <i class="fa-solid fa-pen pw-text-neutral-300 fs-10 pe-0"></i>
                      </label>
                    </div>
                    <!--end::Color picker-->
            ...
            <div class="table-responsive">
              <table class="table">
                <tbody>
                  ...
                  <!--begin::Color picker-->
                  <div class="pw-color-picker-group">
                      <input type="color" class="pw-color-picker" value="#3699FF" id="pw_baslik_renk" name="pw_baslik_renk" />
                      <label class="icon pw-shadow-sm" for="pw_baslik_renk" data-kt-image-input-action="change" data-bs-toggle="tooltip" data-bs-dismiss="click" title="Renk değiştir">
                        <i class="fa-solid fa-pen pw-text-neutral-300 fs-10 pe-0"></i>
                      </label>
                    </div>
                    <!--end::Color picker-->
                  ...
                  <tr>
                    ...
                    <td>
                      <!--begin::Color picker-->
                  <div class="pw-color-picker-group">
                      <input type="color" class="pw-color-picker" value="#3699FF" id="pw_menu_renk" name="pw_menu_renk" />
                      <label class="icon pw-shadow-sm" for="pw_menu_renk" data-kt-image-input-action="change" data-bs-toggle="tooltip" data-bs-dismiss="click" title="Renk değiştir">
                        <i class="fa-solid fa-pen pw-text-neutral-300 fs-10 pe-0"></i>
                      </label>
                    </div>
                    <!--end::Color picker-->
