  ...
  <div class="app-main flex-column flex-row-fluid" id="kt_app_main">
    ...
    <div class="d-flex align-items-center gap-5 border-top border-bottom pw-border-neutral-200 px-6 py-2 my-4">
      <div class="font-poppins fs-8 pw-text-neutral-900 fw-bolder py-1 border-end pw-border-neutral-200 pe-5">
        5 Tanımlı Plugin Tanımlamaları
      </div>
      <a href="/tanimlamalar/sistem/plugin-tanimlamalari/yeni-ekle/" class="btn p-0">
        <span class="btn p-0 fs-9 fs-semibold d-inline-flex align-items-center gap-2" data-bs-toggle="tooltip" data-bs-custom-class="tooltip-inverse" data-bs-placement="bottom" title="Yeni Plugin Tanımlamaları Ekle">
        ...
        <table class="table table-row-bordered border pw-dark-bg-table pw-table-border-gray pw-table-border-gray table-rounded align-middle w-max-content min-w-100 gy-2 gx-9 gs-9">
          ...
          <tbody>
            ...
            <tr class="fw-medium pw-text-neutral-700 fs-8">
              ...
              <td>SQL Server</td>
              <td align="right">
                <a href="/tanimlamalar/sistem/plugin-tanimlamalari/#detay" class="btn btn-icon pw-btn-bg-neutral-100 btn-text-primary pw-btn-hover-bg-neutral-200 w-30px h-30px rounded-0.5" data-bs-toggle="modal" data-bs-target="#detay">
            ...
            <tr class="fw-medium pw-text-neutral-700 fs-8">
              <td>
                <div class="d-flex align-items-center flex-nowrap gap-2">
                  ...
                  <div>Paperwork.Tuyap.Finans.Plugin.CustomDb</div>
                </div>
              </td>
              <td>SQL Server</td>
              <td align="right">
            ...
            <div class="table-responsive overflow-x-auto overflow-lg-hidden">
              <table class="table w-min-content w-100 align-middle gy-5 gx-4">
                <tbody>
                  <!--begin::Row-->
                  <tr>
                    <td><span class="form-label fs-base fw-bolder">Eklenti Adı</span></td>
                    <td>Paperwork.SQLServerPlugIn.SQLPlugIn</td>
                  </tr>
                  <!--end::Row-->

                  <!--begin::Row-->
                  <tr>
                    <td><span class="form-label fs-base fw-bolder">Eklenti Tipi</span></td>
                    <td>SQL Server</td>
                  </tr>
                  <!--end::Row-->
              ...
              <div class="d-flex flex-column gap-6">
                ...
                <a href="/tanimlamalar/dokuman-yonetimi/belge-taslaklari/#belge-taslaklari" class="d-flex align-items-center gap-3">
                  ...
                  <div class="d-flex flex-column gap-1">
                    <div class="fs-9 pw-text-neutral-800 fw-medium"><b>Ezgi Çelik</b> tarafından <b>DEMODb</b> isimli depolama birimi güncellenmiştir.</div>
