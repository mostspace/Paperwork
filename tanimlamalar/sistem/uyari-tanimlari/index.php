...
<div class="app-wrapper flex-column flex-row-fluid" id="kt_app_wrapper">
  ...
  <div class="app-main flex-column flex-row-fluid" id="kt_app_main">
    ...
    <div class="d-flex align-items-center gap-5 border-top border-bottom pw-border-neutral-200 px-6 py-2 my-4">
      ...
      60 Tanımlı Uyarı      </div>
      <a href="/tanimlamalar/sistem/uyari-tanimlari/yeni-ekle/" type="button" class="btn p-0">
        <span class="btn p-0 fs-9 fs-semibold d-inline-flex align-items-center gap-2" data-bs-toggle="tooltip" data-bs-custom-class="tooltip-inverse" data-bs-placement="bottom" title="Yeni Uyarı Ekle">
        ...
        <table class="table table-row-bordered border pw-table-border-gray table-rounded align-middle w-max-content min-w-100 gy-2 gx-9 gs-9">
          ...
          <tbody>
            ...
            <tr class="fw-medium pw-text-neutral-700 fs-8">
              ...
              <td align="right">
                <!--end::Menu wrapper-->
                <a href="/tanimlamalar/sistem/metod-tanimlari/#detay" class="btn btn-icon pw-btn-bg-neutral-100 btn-text-primary pw-btn-hover-bg-neutral-200 w-30px h-30px rounded-0.5" data-bs-toggle="modal" data-bs-target="#detay">
                  <i class="fa-solid fa-eye fs-7 text-primary"></i>
                </a>
                <a href="tanimlamalar/sistem/metod-tanimlari#" class="btn btn-icon pw-btn-bg-neutral-100 btn-text-primary pw-btn-hover-bg-neutral-200 w-30px h-30px rounded-0.5">
  ...
  <div class="modal-dialog modal-dialog-centered modal-lg mw-950px">
    <div class="modal-content">
      <div class="modal-header border-0 pb-3">
        <h3 class="modal-title fs-5">Uyarı-1</h3>
            ...
            <div class="table-responsive overflow-x-auto overflow-lg-hidden">
              <table class="table w-min-content w-100 align-middle gy-5 gx-4">
                <tbody>
                  <!--begin::Row-->
                  <tr>
                    <td><span class="form-label fs-base fw-bolder">Durumu</span></td>
                  ...
                  <tr>
                    ...
                    <td>EFatura entegratörü web servis hatası</td>
                  </tr>
                  <!--end::Row-->

                  <!--begin::Row-->
                  <tr>
                    <td><span class="form-label fs-base fw-bolder">Uyarı</span></td>
                    <td>Sayın yetkili,
EFatura entegratörü (@@INTEGRATOR@@) web servisine '@@CURRENT_DURATION@@' dakikadır ulaşılamıyor.</td>
                  </tr>
                  <!--end::Row-->

                  <!--begin::Row-->
                  <tr>
                    <td><span class="form-label fs-base fw-bolder">Son Erişim Zamanı</span></td>
                  ...
                  <!--begin::Row-->
                  <tr>
                    <td><span class="form-label fs-base fw-bolder">Çağrı Zamanı</span></td>
                    <td>@@REQUESTTIMETIME@@</td>
                  </tr>
                  <!--end::Row-->

                  <!--begin::Row-->
                  <tr>
                    <td><span class="form-label fs-base fw-bolder">E-Posta</span></td>
                    <td>-</td>
                  </tr>
                  <!--end::Row-->
                </tbody>
