  ...
  <div class="app-main flex-column flex-row-fluid" id="kt_app_main">
      ...
      <div id="kt_app_toolbar_container" class="container-fluid d-flex flex-stack p-0">
        ...
        <div class="page-title d-flex flex-column justify-content-center flex-wrap me-3">
          ...
          <ul class="breadcrumb breadcrumb-separatorless fw-semibold fs-8 mt-0 mb-3">
            ...
            <!--end::Item-->
            <!--begin::Item-->
            <li class="breadcrumb-item active">Web Servis Tanımları</li>
            <!--end::Item-->
          </ul>
          <!--end::Breadcrumb-->
          <!--begin::Title-->
    ...
    <div class="d-flex align-items-center gap-5 border-top border-bottom pw-border-neutral-200 px-6 py-2 my-4">
      <div class="font-poppins fs-8 pw-text-neutral-900 fw-bold py-1 border-end pw-border-neutral-200 pe-5">
        18 Tanımlı Web Servis
      </div>
      <a href="/tanimlamalar/sistem/web-servis-tanimlari/yeni-ekle/" type="button" class="btn p-0">
        <span class="btn p-0 fs-9 fs-semibold d-inline-flex align-items-center gap-2" data-bs-toggle="tooltip" data-bs-custom-class="tooltip-inverse" data-bs-placement="bottom" title="Yeni Servis Ekle">
        ...
        <table class="table table-row-bordered border pw-table-border-gray table-rounded align-middle w-max-content min-w-100 gy-2 gx-9 gs-9">
          ...
          <tbody>
            ...
            <tr class="fw-medium pw-text-neutral-700 fs-8">
              <td>
                <div class="d-flex align-items-center flex-nowrap gap-2">
                  ...
                  <div>2022 Özel Günler</div>
                </div>
              </td>
              <td>-</td>
              <td align="right">
                <!--end::Menu wrapper-->
                <a href="/tanimlamalar/sistem/web-servis-tanimlari/#detay" class="btn btn-icon pw-btn-bg-neutral-100 btn-text-primary pw-btn-hover-bg-neutral-200 w-30px h-30px rounded-0.5" data-bs-toggle="modal" data-bs-target="#detay">
                  <i class="fa-solid fa-eye fs-7 text-primary"></i>
                </a>
                <a href="tanimlamalar/sistem/web-servis-tanimlari#" class="btn btn-icon pw-btn-bg-neutral-100 btn-text-primary pw-btn-hover-bg-neutral-200 w-30px h-30px rounded-0.5">
            ...
            <tr class="fw-medium pw-text-neutral-700 fs-8">
              ...
              <td>Bu liste Aydın Des Tech Firması İK...</td>
              <td align="right">
                <!--end::Menu wrapper-->
                <a href="/tanimlamalar/sistem/web-servis-tanimlari/#detay" class="btn btn-icon pw-btn-bg-neutral-100 btn-text-primary pw-btn-hover-bg-neutral-200 w-30px h-30px rounded-0.5" data-bs-toggle="modal" data-bs-target="#detay">
                  <i class="fa-solid fa-eye fs-7 text-primary"></i>
  ...
  <div class="modal-dialog modal-dialog-centered modal-lg mw-950px">
    <div class="modal-content">
      <div class="modal-header border-0 pb-3">
        <h3 class="modal-title fs-5">Toyota</h3>
