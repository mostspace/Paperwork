...
<div class="app-wrapper flex-column flex-row-fluid" id="kt_app_wrapper">
  ...
  <div class="app-main flex-column flex-row-fluid" id="kt_app_main">
      ...
      <div id="kt_app_toolbar_container" class="container-fluid d-flex flex-stack p-0">
        ...
        <div class="page-title d-flex flex-column justify-content-center flex-wrap me-3">
          ...
          <ul class="breadcrumb breadcrumb-separatorless fw-semibold fs-8 mt-0 mb-3">
            ...
            <!--end::Item-->
            <!--begin::Item-->
            <li class="breadcrumb-item active">Liste Tanımları</li>
            <!--end::Item-->
          </ul>
          <!--end::Breadcrumb-->
          <!--begin::Title-->
    ...
    <div class="d-flex align-items-center gap-5 border-top border-bottom pw-border-neutral-200 px-6 py-2 my-4">
      ...
      <a href="/tanimlamalar/sistem/liste-tanimlari/yeni-ekle" type="button" class="btn p-0">
        <span class="btn p-0 fs-9 fs-semibold d-inline-flex align-items-center gap-2" data-bs-toggle="tooltip" data-bs-custom-class="tooltip-inverse" data-bs-placement="bottom" title="Yeni Liste Ekle">
        ...
        <table class="table table-row-bordered border pw-table-border-gray table-rounded align-middle w-max-content min-w-100 gy-2 gx-9 gs-9">
          ...
          <tbody>
            ...
            <tr class="fw-medium pw-text-neutral-700 fs-8 pw-bg-primary-50">
              <td>
                <div class="d-flex align-items-center flex-nowrap gap-2">
                  <div class="w-35px h-35px d-inline-flex align-items-center justify-content-center rounded-circle pw-bg-neutral-100 flex-shrink-0">
                    <i class="fa-solid fa-clock-rotate-left fs-7 pw-text-brand"></i>
                  </div>
                  <div>Avas Talep Döküman</div>
                </div>
              </td>
              ...
              <td align="right">
                <!--end::Menu wrapper-->
                <a href="/tanimlamalar/sistem/liste-tanimlari/#detay" class="btn btn-icon pw-btn-bg-neutral-100 btn-text-primary pw-btn-hover-bg-neutral-200 w-30px h-30px rounded-0.5" data-bs-toggle="modal" data-bs-target="#detay">
                  <i class="fa-solid fa-eye fs-7 text-primary"></i>
                </a>
                <a href="tanimlamalar/sistem/liste-tanimlari#" class="btn btn-icon pw-btn-bg-neutral-100 btn-text-primary pw-btn-hover-bg-neutral-200 w-30px h-30px rounded-0.5">
            ...
            <tr class="fw-medium pw-text-neutral-700 fs-8">
              <td>
                <div class="d-flex align-items-center flex-nowrap gap-2">
                  ...
                  <div>Adliye Listesi</div>
                </div>
              </td>
              <td>Adliye Listesi</td>
              <td>-</td>
              <td align="right">
                <!--end::Menu wrapper-->
                <a href="/tanimlamalar/sistem/liste-tanimlari/#detay" class="btn btn-icon pw-btn-bg-neutral-100 btn-text-primary pw-btn-hover-bg-neutral-200 w-30px h-30px rounded-0.5" data-bs-toggle="modal" data-bs-target="#detay">
            ...
            <tr class="fw-medium pw-text-neutral-700 fs-8">
              <td>
                <div class="d-flex align-items-center flex-nowrap gap-2">
                  ...
                  <div>AD-Masraf Türü</div>
                </div>
              </td>
              <td>AD-Masraf Türü</td>
              <td>-</td>
              <td align="right">
                <!--end::Menu wrapper-->
                <a href="/tanimlamalar/sistem/liste-tanimlari/#detay" class="btn btn-icon pw-btn-bg-neutral-100 btn-text-primary pw-btn-hover-bg-neutral-200 w-30px h-30px rounded-0.5" data-bs-toggle="modal" data-bs-target="#detay">
            ...
            <tr class="fw-medium pw-text-neutral-700 fs-8">
              <td>
                <div class="d-flex align-items-center flex-nowrap gap-2">
                  ...
                  <div>ADT İzin Türü Listesi</div>
                </div>
              </td>
              <td>ADT İzin Türü Listesi</td>
              <td>-</td>
              <td align="right">
                <!--end::Menu wrapper-->
                <a href="/tanimlamalar/sistem/liste-tanimlari/#detay" class="btn btn-icon pw-btn-bg-neutral-100 btn-text-primary pw-btn-hover-bg-neutral-200 w-30px h-30px rounded-0.5" data-bs-toggle="modal" data-bs-target="#detay">
  ...
  <div class="modal-dialog modal-dialog-centered modal-lg mw-950px">
    <div class="modal-content">
      <div class="modal-header border-0 pb-3">
        <h3 class="modal-title fs-5">2022 Özel Günler</h3>
            ...
            <div class="table-responsive overflow-x-auto overflow-lg-hidden">
              <table class="table w-min-content w-100 align-middle gy-5 gx-4">
                <tbody>
                  ...
                  <!--begin::Row-->
                  <tr>
                    <td><span class="form-label fs-base fw-bolder">Tanım</span></td>
                    <td>2022_Özel_Günler</td>
                  </tr>
                  <!--end::Row-->
                  ...
                  <tr>
                    ...
                    <td>Lorem ipsum dolor sit amet, consecteur.</td>
                  </tr>
                  <!--end::Row-->
                </tbody>
              </table>
