  ...
  <div class="app-main flex-column flex-row-fluid" id="kt_app_main">
    ...
    <div class="d-flex align-items-center gap-5 border-top border-bottom pw-border-neutral-200 px-6 py-2 my-4">
      <div class="font-poppins fs-8 pw-text-neutral-900 fw-bolder py-1 border-end pw-border-neutral-200 pe-5">
        3 Tanımlı Entegrasyon Tanımları
      </div>
      <a href="/tanimlamalar/sistem/entegrasyon-tanimlari/yeni-ekle/" class="btn p-0">
        <span class="btn p-0 fs-9 fs-semibold d-inline-flex align-items-center gap-2" data-bs-toggle="tooltip" data-bs-custom-class="tooltip-inverse" data-bs-placement="bottom" title="Yeni Entegrasyon Tanımı Ekle">
        ...
        <table class="table table-row-bordered border pw-dark-bg-table pw-table-border-gray pw-table-border-gray table-rounded align-middle w-max-content min-w-100 gy-2 gx-9 gs-9">
          <thead>
            <tr class="fw-semibold fs-8 pw-text-neutral-700 pw-bg-neutral-100">
              <th class="py-3">Entegrasyon Adı</th>
              <th class="py-3">Entegrasyon Tipi</th>
              <th class="py-3"></th>
            </tr>
          </thead>
          <tbody>
            ...
            <tr class="fw-medium pw-text-neutral-700 fs-8">
              <td>
                <div class="d-flex align-items-center flex-nowrap gap-2">
                  <div class="w-35px h-35px d-inline-flex align-items-center justify-content-center rounded-circle pw-bg-neutral-100 flex-shrink-0">
                    <i class="fa-solid fa-plug pw-text-primary-500"></i>
                  </div>
                  <div>Logo</div>
                </div>
              </td>
              <td>Logo</td>
              <td align="right">
                <a href="/tanimlamalar/sistem/entegrasyon-tanimlari/#detay" class="btn btn-icon pw-btn-bg-neutral-100 btn-text-primary pw-btn-hover-bg-neutral-200 w-30px h-30px rounded-0.5" data-bs-toggle="modal" data-bs-target="#detay">
                  <i class="fa-solid fa-eye fs-7 text-primary"></i>
                </a>
                <a href="/tanimlamalar/sistem/entegrasyon-tanimlari/#" class="btn btn-icon pw-btn-bg-neutral-100 btn-text-primary pw-btn-hover-bg-neutral-200 w-30px h-30px rounded-0.5" data-bs-toggle="modal" data-bs-target="#duzenle">
                  <i class="fa-solid fa-pen-to-square fs-7 text-primary"></i>
                </a>
                <a href="/tanimlamalar/sistem/entegrasyon-tanimlari/#" class="btn btn-icon pw-btn-bg-neutral-100 btn-text-primary pw-btn-hover-bg-neutral-200 w-30px h-30px rounded-0.5">
  ...
  <div class="modal-dialog modal-dialog-centered modal-lg mw-950px">
    <div class="modal-content">
      <div class="modal-header border-0 pb-3">
        <h3 class="modal-title fs-5">Logo</h3>
            ...
            <div class="table-responsive overflow-x-auto overflow-lg-hidden">
              <table class="table w-min-content w-100 align-middle gy-5 gx-4">
                <tbody>
                  ...
                  <!--begin::Row-->
                  <tr>
                    <td><span class="form-label fs-base fw-bolder">Entegrasyon Tipi</span></td>
                    <td>Logo</td>
                  </tr>
                  <!--end::Row-->
                  ...
                  <!--begin::Row-->
                  <tr>
                    <td><span class="form-label fs-base fw-bolder">Domain</span></td>
                    <td>-</td>
                  </tr>
                  <!--end::Row-->
                  ...
                  <!--begin::Row-->
                  <tr>
                    <td><span class="form-label fs-base fw-bolder">Güvenlik Anahtarı</span></td>
                    <td>GgSoftTest</td>
                  </tr>
                  <!--end::Row-->
                  ...
                  <!--begin::Row-->
                  <tr>
                    <td><span class="form-label fs-base fw-bolder">End point</span></td>
                    <td>http://192.168.1.64/ELC.svc</td>
                  </tr>
                  <!--end::Row-->
                </tbody>
              </table>
