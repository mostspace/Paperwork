        ...
        <div class="table-responsive overflow-x-auto overflow-lg-hidden">
            <table class="table w-min-content w-100 gy-3 gx-4 pw-text-neutral-800 fw-bold fs-7">
                <tbody>
                    <!--begin::Row-->
                    <tr>
                        <td class="col col-md-3"><label for="sablon-no">Şablon No</label></td>
                        <td class="col col-md-9">
                            <a href="javascript:void(0);" class="text-decoration-underline">AA13123AD3483AFDGG</a>
                        </td>
                    </tr>
                    <!--end::Row-->
                    <!--begin::Row-->
                    <tr>
                        <td class="col col-md-3"><label for="sablon-adi">Şablon Adı</label></td>
                        <td class="col col-md-9">
                            <input type="text" class="form-control form-control-solid py-3 px-4 fs-8" id="sablon-adi" name="sablon-adi"  />
                        </td>
                    </tr>
                    <!--end::Row-->
                    <!--begin::Row-->
                    <tr>
                        <td class="col col-md-3"><label for="iliskili-tip">İlişkili Tip</label></td>
                        <td class="col col-md-9">
                            <input type="text" class="form-control form-control-solid py-3 px-4 fs-8" id="iliskili-tip" name="iliskili-tip"  />
                        </td>
                    </tr>
                    <!--end::Row-->
                    ...
                    <!--begin::Row-->
                    <tr>
                        <td class="col col-md-3"><label for="varsayilan-sablon">Varsayılan Şablon</label></td>
                        <td class="col col-md-9">
                    ...
                    <tr>
                        ...
                        <td class="col col-md-9">
                            <textarea class="form-control form-control-solid" name="aciklama" id="aciklama" cols="30" rows="3"></textarea>
                        </td>
                    </tr>
                    <!--end::Row-->
                </tbody>
