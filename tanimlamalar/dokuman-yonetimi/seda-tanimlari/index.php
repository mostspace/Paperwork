...
<div class="app-wrapper flex-column flex-row-fluid" id="kt_app_wrapper">
  ...
  <!--begin::Main-->
  <div class="app-main flex-column flex-row-fluid" id="kt_app_main"></div>
    ...
    <div id="kt_app_toolbar_container" class="container-fluid d-flex flex-stack p-0">
      ...
      <div class="page-title d-flex flex-column justify-content-center flex-wrap me-3">
        ...
        <ul class="breadcrumb breadcrumb-separatorless fw-semibold fs-8 mt-0 mb-3">
          ...
          <!--end::Item-->
          <!--begin::Item-->
          <li class="breadcrumb-item active">SEDA Tanımları</li>
          <!--end::Item-->
        </ul>
        <!--end::Breadcrumb-->
        <!--begin::Title-->
  ...
  <div class="d-flex align-items-center gap-5 border-top border-bottom pw-border-neutral-200 px-6 py-2 my-4">
    <div class="font-poppins fs-8 pw-text-neutral-900 fw-bolder py-1 border-end pw-border-neutral-200 pe-5">
      8 Tanımlı SEDA Tanımı
    </div>
    <a href="/tanimlamalar/dokuman-yonetimi/seda-tanimlari/#" class="btn p-0">
      <span class="btn p-0 fs-9 fs-semibold d-inline-flex align-items-center gap-2" data-bs-toggle="tooltip" data-bs-custom-class="tooltip-inverse" data-bs-placement="bottom" title="Yeni SEDA Tanımı Ekle">
  ...
  <div class="col-12 col-md-11 mb-20 px-6 pb-6">
    <!--begin::Title-->
    <h2 class="pw-text-neutral-800 fs-4 fw-bolder font-poppins">Profiller</h2>
    <!--end::Title-->
      ...
      <table class="table table-row-bordered border pw-dark-bg-table pw-table-border-gray pw-table-border-gray table-rounded align-middle w-max-content min-w-100 gy-2 gx-9 gs-9">
        ...
        <tbody>
          ...
          <tr class="fw-medium pw-text-neutral-700 fs-8">
            ...
            <td>Araştırma Merkezi Arşivi\</td>
            <td align="right">
              <!--begin::Menu wrapper-->

              <!--begin::Menu toggle-->
              <button type="button" data-kt-menu-trigger="click" data-kt-menu-placement="bottom-start" data-kt-menu-offset="-150px,15px" class="btn btn-icon pw-btn-bg-neutral-100 btn-text-primary pw-btn-hover-bg-neutral-200 w-30px h-30px rounded-0.5">
                <i class="fa-solid fa-copy fs-7 text-primary"></i>
              </button>
              <!--end::Menu toggle-->

              <!--begin::Menu dropdown-->
              <div class="menu menu-sub menu-sub-dropdown w-325px text-start shadow-sm rounded" data-kt-menu="true" id="seda_clone_menu">
                <!--begin::Header-->
                <div class="px-7 py-5">
                  <div class="fs-5 text-dark fw-bold">Kopyala</div>
                </div>
                <!--end::Header-->
                ...
                <div class="p-2">
                  ...
                  <div class="row my-6">
                    ...
                    <div class="col-8 px-2 py-0">
                      <input class="form-control form-control-solid py-2 px-3 fs-8" value="Araştırma Merkezi Arşiv" required="required" />
                    </div>
                    <!--end::Form-->
                  </div>
                  <!--end::Input group-->
                  ...
                  <div class="d-flex justify-content-end">
                    <button type="reset" class="btn btn-sm btn-light btn-active-light-primary me-2" data-kt-menu-dismiss="true">Hayır</button>

                    <button type="submit" class="btn btn-sm btn-primary" data-kt-menu-dismiss="true">Evet</button>
                  </div>
                  <!--end::Actions-->
                </div>
                <!--end::Form-->
              ...
              <!--end::Menu wrapper-->
              <a href="tanimlamalar/dokuman-yonetimi/seda-tanimlari/detay" class="btn btn-icon pw-btn-bg-neutral-100 btn-text-primary pw-btn-hover-bg-neutral-200 w-30px h-30px rounded-0.5">
                <i class="fa-solid fa-eye fs-7 text-primary"></i>
              </a>
              <a href="tanimlamalar/dokuman-yonetimi/seda-tanimlari/#" class="btn btn-icon pw-btn-bg-neutral-100 btn-text-primary pw-btn-hover-bg-neutral-200 w-30px h-30px rounded-0.5" data-bs-toggle="modal" data-bs-target="#arastırma-merkezi-arsiv">
                <i class="fa-solid fa-pen-to-square fs-7 text-primary"></i>
              </a>
              <a href="tanimlamalar/dokuman-yonetimi/seda-tanimlari/#" class="btn btn-icon pw-btn-bg-neutral-100 btn-text-primary pw-btn-hover-bg-neutral-200 w-30px h-30px rounded-0.5">
          ...
          <tr class="fw-medium pw-text-neutral-700 fs-8">
            ...
            <td>Çalışan Oryantasyon Arşiv\</td>
            <td align="right">
              <a href="tanimlamalar/dokuman-yonetimi/seda-tanimlari/#" class="btn btn-icon pw-btn-bg-neutral-100 btn-text-primary pw-btn-hover-bg-neutral-200 w-30px h-30px rounded-0.5">
                <i class="fa-solid fa-copy fs-7 text-primary"></i>
              </a>
          ...
          <tr class="fw-medium pw-text-neutral-700 fs-8">
            ...
            <td>Destek Hızlı Arşiv Testleri\</td>
            <td align="right">
              <a href="tanimlamalar/dokuman-yonetimi/seda-tanimlari/#" class="btn btn-icon pw-btn-bg-neutral-100 btn-text-primary pw-btn-hover-bg-neutral-200 w-30px h-30px rounded-0.5">
                <i class="fa-solid fa-copy fs-7 text-primary"></i>
              </a>
