...
<div class="app-wrapper flex-column flex-row-fluid" id="kt_app_wrapper">
  ...
  <div class="app-main flex-column flex-row-fluid" id="kt_app_main">
    ...
    <div class="d-flex align-items-center gap-5 border-top border-bottom pw-border-neutral-200 px-6 py-2 my-4">
      ...
      <a href="/tanimlamalar/dokuman-yonetimi/e-fatura/yeni-ekle/" class="btn p-0">
        <span class="btn p-0 fs-9 fs-semibold d-inline-flex align-items-center gap-2" data-bs-toggle="tooltip" data-bs-custom-class="tooltip-inverse" data-bs-placement="bottom" title="Yeni E-Fatura Ekle">
        ...
        <table class="table table-row-bordered border pw-dark-bg-table pw-table-border-gray pw-table-border-gray table-rounded align-middle w-max-content min-w-100 gy-2 gx-9 gs-9">
          <thead>
            <tr class="fw-semibold fs-8 pw-text-neutral-700 pw-bg-neutral-100">
              <th class="py-3">Transfer Adı</th>
              <th class="py-3">Transfer Türü</th>
              <th class="py-3">Türü</th>
              <th class="py-3"></th>
            </tr>
          </thead>
          <tbody>
            ...
            <tr class="fw-medium pw-text-neutral-700 fs-8 pw-bg-primary-50">
              ...
              <td align="right">
                <a href="/tanimlamalar/dokuman-yonetimi/e-fatura/detay/" class="btn btn-icon pw-btn-bg-neutral-100 pw-btn-hover-bg-neutral-200 w-30px h-30px rounded-0.5">
                  <i class="fa-solid fa-eye fs-7 pw-text-brand"></i>
                </a>
                <a href="/tanimlamalar/dokuman-yonetimi/e-fatura/#e-fatura" class="btn btn-icon pw-btn-bg-neutral-100 pw-btn-hover-bg-neutral-200 w-30px h-30px rounded-0.5" data-bs-toggle="modal" data-bs-target="#e-fatura">
                  <i class="fa-solid fa-pen-to-square fs-7 pw-text-brand"></i>
                </a>
                <a href="/tanimlamalar/dokuman-yonetimi/e-fatura#" class="btn btn-icon pw-btn-bg-neutral-100 pw-btn-hover-bg-neutral-200 w-30px h-30px rounded-0.5">
            ...
            <tr class="fw-medium pw-text-neutral-700 fs-8 pw-bg-primary-50">
              <td>
                <div class="d-flex align-items-center flex-nowrap gap-2">
                  <div class="w-35px h-35px d-inline-flex align-items-center justify-content-center rounded-circle pw-bg-primary-200 flex-shrink-0" data-bs-toggle="modal" data-bs-target="#e-fatura">
                    <i class="fa-solid fa-file-lines pw-text-primary"></i>
                  </div>
                  <div>
                    Belge Taslağı Sistem
            ...
            <tr class="fw-medium pw-text-neutral-700 fs-8">
              <td>
                <div class="d-flex align-items-center flex-nowrap gap-2">
                  <div class="w-35px h-35px d-inline-flex align-items-center justify-content-center rounded-circle pw-bg-neutral-100 flex-shrink-0" data-bs-toggle="modal" data-bs-target="#e-fatura">
                    <i class="fa-solid fa-file-invoice pw-text-primary"></i>
                  </div>
                  <div>
                    E-Fatura
                  </div>
...
<!--begin::Modal-->
<div class="modal fade" tabindex="-1" id="e-fatura">
  <div class="modal-dialog modal-dialog-centered modal-lg mw-650px">
    <div class="modal-content">
      <div class="modal-header">
        <h2 class="modal-title">E-Fatura</h2>
      </div>
              ...
              <div class="table-responsive">
                <table class="table">
                  <tbody>
                    ...
                    <tr>
                      <td>
                        <label class="fs-8 fw-bolder" for="transfer_adi">Transfer Adı</label>
                      </td>
                      <td>
                        <input id="transfer_adi" type="text" class="form-control form-control-solid mb-3 mw-md-375px w-100 fs-8" name="transfer_adi" />
                      </td>
                    </tr>
                    <!--end::Row-->
                    ...
                    <tr>
                      <td>
                        <label class="fs-8 fw-bolder" for="transfer_turu">Transfer Türü</label>
                      </td>
                      <td>
                        <input id="transfer_turu" type="text" class="form-control form-control-solid mb-3 mw-md-375px w-100 fs-8" name="transfer_turu" />
                      </td>
                    </tr>
                    <!--end::Row-->
                    ...
                    <tr>
                      <td>
                        <label class="fs-8 fw-bolder" for="transfer_aktif">Aktif</label>
                      </td>
                      <td>
                        <div class="form-check form-switch form-check-custom form-check-solid">
                          <input class="form-check-input" type="checkbox" value="" id="transfer_aktif" name="transfer_aktif" />
                        </div>
                      </td>
                    </tr>
                    <!--end::Row-->
