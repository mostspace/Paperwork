...
<div class="app-wrapper flex-column flex-row-fluid" id="kt_app_wrapper">
  ...
  <div class="app-main flex-column flex-row-fluid" id="kt_app_main">
    ...
    <div class="d-flex align-items-center gap-5 border-top border-bottom pw-border-neutral-200 px-6 py-2 mt-4">
      <div data-bs-toggle="tooltip" data-bs-custom-class="tooltip-inverse" data-bs-placement="bottom" data-bs-original-title="Çıkar" data-kt-initialized="1">
        <button class="btn p-0 fs-9 fs-semibold d-inline-flex align-items-center gap-1">
          ...
          <span class="text-black">Çıkar</span>
        </button>
      </div>
            ...
            <div class="border rounded-3 pw-border-stroke px-6 py-5">
              ...
              <div class="table-reponsive overflow-x-auto overflow-y-hidden">
                ...
                <div class="nav nav-tabs nav-line-tabs gap-6 fs-6 border-0 flex-nowrap w-max-content" role="tablist">
                  ...
                  <!--begin::Tab item-->
                  <li class="nav-item" role="presentation">
                    <a class="nav-link mx-0 fs-base rounded-0 border-0 fw-medium" data-bs-toggle="tab" href="#pw_tab_pane_tip_detay" role="tab">
                  ...
                  <!--begin::Tab item-->
                  <li class="nav-item" role="presentation">
                    <a class="nav-link mx-0 fs-base rounded-0 border-0 fw-medium" data-bs-toggle="tab" href="#pw_tab_pane_tip_paylasilan_kodlar" role="tab">
                  ...
                  <!--begin::Tab item-->
                  <li class="nav-item" role="presentation">
                    <a class="nav-link mx-0 fs-base rounded-0 border-0 fw-medium" data-bs-toggle="tab" href="#pw_tab_pane_tip_tarihce" role="tab">
                        ...
                        <table class="table w-min-content w-100 gy-3 gx-4 pw-text-neutral-800 fs-7">
                          <tbody>
                            ...
                            <tr>
                              ...
                              <td>
                                <input type="text" class="form-control form-control-solid py-3 px-4 fs-8" id="pw_tip_adi" name="pw_tip_adi" required />
                              </td>
                            </tr>
                            <!--end::Row-->
                            ...
                            <!--begin::Row-->
                            <tr>
                              <td><label class="form-label fs-base fw-bolder" for="pw_tasarim_yetki_seti">Tasarım Yetki Seti</label></td>
                              <td>
                                <select id="pw_tasarim_yetki_seti" class="form-select form-select-solid fs-8 py-3 px-4" data-control="select2" data-placeholder="">
                                  <option value="1" seleted>Option 1</option>
                                </select>
                              </td>
                            </tr>
                            <!--end::Row-->
                            ...
                            <!--begin::Row-->
                            <tr>
                              <td><label class="form-label fs-base fw-bolder" for="pw_geri_donusum">Geri Dönüşüm</label></td>
                              <td>
                                <select id="pw_geri_donusum" class="form-select form-select-solid fs-8 py-3 px-4" data-control="select2" data-placeholder="">
                                  <option value="1" seleted>Option 1</option>
                                </select>
                              </td>
                            </tr>
