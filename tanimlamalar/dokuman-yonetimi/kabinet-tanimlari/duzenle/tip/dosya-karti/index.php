        ...
        <div class="table-reponsive overflow-x-auto mt-4">
          ...
          <div class="nav nav-tabs nav-line-tabs fs-6" role="tablist">
            ...
            <li class="nav-item" role="presentation">
              <a class="nav-link mx-0 py-3 px-10 fs-base rounded-0 fw-medium active" data-bs-toggle="tab" href="#pw_tab_pane_dosya_karti" aria-selected="true" role="tab">Dosya Kartı</a>
            </li>
            <!--end::Tab item-->
          </div>
          <!--end::Tabs-->
                  ...
                  <div class="table-responsive overflow-x-auto overflow-lg-hidden">
                    <table class="table w-min-content w-100 gy-3 gx-4 pw-text-neutral-800 fs-7">
                      <tbody>
                        ...
                        <!--begin::Row-->
                        <tr>
                          <td><label class="form-label fs-base fw-bolder">Sahibi</label></td>
                          <td>Dosya Kartı</td>
                        </tr>
                        <!--end::Row-->
                        ...
                        <!--begin::Row-->
                        <tr>
                          <td><label class="form-label fs-base fw-bolder">Yaratılış Tarihi</label></td>
                          <td>14.12.2022 - 15:52:09</td>
                        </tr>
                        <!--end::Row-->

                        <!--begin::Row-->
                        <tr>
                          <td><label class="form-label fs-base fw-bolder">Değiştiren</label></td>
                          <td>Ezgi Çelik</td>
                        </tr>
                        <!--end::Row-->
                        ...
                        <!--begin::Row-->
                        <tr>
                          <td><label class="form-label fs-base fw-bolder">Değişim Tarihi</label></td>
                          <td>14.12.2022 - 15:52:09</td>
                        </tr>
                        <!--end::Row-->
                      </tbody>
