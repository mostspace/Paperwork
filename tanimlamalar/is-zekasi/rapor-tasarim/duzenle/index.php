    ...
    <div class="col-12 col-md-11 mb-20 px-6 pb-6 mt-4 mt-xl-6">
      ...
      <div class="table-reponsive overflow-x-auto">
        ...
        <div class="nav nav-tabs nav-line-tabs fs-6 gap-8" role="tablist">
          ...
          <!--begin::Tab item-->
          <li class="nav-item" role="presentation">
            <a class="nav-link mx-0 pt-0 pb-3 fs-base rounded-0 fw-semibold active" data-bs-toggle="tab" href="#pw_tab_pane_kisa_yol" role="tab">Kısa Yol</a>
          </li>
          <!--end::Tab item-->
          ...
          <!--begin::Tab item-->
          <li class="nav-item" role="presentation">
            <a class="nav-link mx-0 pt-0 pb-3 fs-base rounded-0" data-bs-toggle="tab" href="#pw_tab_pane_tanimli_is" role="tab">Tanımlı İş</a>
          </li>
          <!--end::Tab item-->
        </div>
        <!--end::Table tabs-->
      ...
      <div class="tab-content pw-dashboard-tab-content mt-2" id="raporTasarimiTab">
        ...
        <!--begin::Kısa yol content-->
        <div class="tab-pane fade show active" id="pw_tab_pane_kisa_yol" role="tabpanel">
          <!--begin::Card-->
          <div class="border rounded-1 pw-border-stroke px-xxl-8 py-xxl-8 p-4">
            <button type="button" class="btn btn-primary fs-8 px-4 py-2" data-bs-toggle="modal" data-bs-target="#kisa-yol">Kısa Yol</button>
          </div>
          <!--end::Card-->
        </div>
        <!--end::Kısa yol content-->
        ...
        <div class="tab-pane fade" id="pw_tab_pane_tanimli_is" role="tabpanel">
          <!--begin::Button-->
          <a href="/tanimlamalar/is-zekasi/rapor-tasarim/yeni/tanimli-is-ekle" class="btn btn-outline btn-outline btn-outline-primary btn-active-light-primary px-4 py-2 fs-8 mb-2 rounded-0.25rem">
...
<!-- begin::Modal -->
<div class="modal fade" tabindex="-1" id="kisa-yol">
  <div class="modal-dialog modal-dialog-centered modal-lg mw-800px">
    <div class="modal-content">
      <div class="modal-header border pb-3">
        <h3 class="modal-title fs-5">Rapor Kısa Yolu</h3>
      ...
      <div class="modal-body">
        <!--begin::Card-->
        <div class="border pw-border-stroke rounded-1 p-4">
          <div class="d-flex align-items-center gap-6 gap-md-8 mb-6">
            <button type="button" class="btn btn-outline btn-outline btn-outline-primary btn-active-light-primary fs-8 px-4 py-2">5</button>
            <button type="button" class="btn btn-primary fs-8 px-4 py-2">Oluştur</button>
            <button type="button" class="btn btn-primary fs-8 px-4 py-2">Git</button>
          </div>

          <!--begin::Card-->
          <div class="border pw-border-stroke rounded-1 p-4">
            <h4 class="text-black fs-2 fw-semibold">https://uidesk</h4>
          </div>
          <!--end::Card-->
        </div>
        <!--end::Card-->
