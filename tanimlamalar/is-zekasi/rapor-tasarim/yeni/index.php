  ...
  <div class="app-main flex-column flex-row-fluid" id="kt_app_main">
    ...
    <div class="col-12 col-md-11 mb-20 px-6 pb-6 mt-4 mt-xl-6">
      ...
      <div class="table-reponsive overflow-x-auto">
        ...
        <div class="nav nav-tabs nav-line-tabs fs-6 gap-8" role="tablist">
          ...
          <li class="nav-item" role="presentation">
            <a class="nav-link mx-0 pt-0 pb-3 fs-base rounded-0 fw-semibold active" data-bs-toggle="tab" href="#pw_tab_pane_detay" role="tab">Detay</a>
          </li>
          <!--end::Tab item-->
      ...
      <div class="tab-content pw-dashboard-tab-content mt-2" id="raporTasarimiTab">
        <!--begin::Detay content-->
        <div class="tab-pane fade show active" id="pw_tab_pane_detay" role="tabpanel">
          <!--begin::Card-->
