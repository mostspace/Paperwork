  ...
  <div class="app-main flex-column flex-row-fluid" id="kt_app_main">
      ...
      <div id="kt_app_toolbar_container" class="container-fluid d-flex flex-stack p-0">
        ...
        <div class="page-title d-flex flex-column justify-content-center flex-wrap me-3">
          ...
          <ul class="breadcrumb breadcrumb-separatorless fw-semibold fs-8 mt-0 mb-3">
            ...
            <!--end::Item-->
            <!--begin::Item-->
            <li class="breadcrumb-item active">Veri Kaynakları</li>
            <!--end::Item-->
          </ul>
          <!--end::Breadcrumb-->
          <!--begin::Title-->
        ...
        <div class="app-navbar-item ms-1 ms-md-3">
          <!--begin::Menu toggle-->
          <a href="/tanimlamalar/is-zekasi/veri-kaynaklari/#" class="btn btn-icon btn-custom btn-icon-muted btn-active-light btn-active-color-primary w-30px h-30px w-md-40px h-md-40px" data-kt-menu-trigger="{default:'click', lg: 'hover'}" data-kt-menu-attach="parent" data-kt-menu-placement="bottom-end">
          ...
          <div class="menu menu-sub menu-sub-dropdown menu-column menu-rounded menu-title-gray-700 menu-icon-gray-500 menu-active-bg menu-state-color fw-semibold py-4 fs-base w-200px" data-kt-menu="true" data-kt-element="theme-mode-menu">
            ...
            <div class="menu-item px-3 my-0">
              <a href="/tanimlamalar/is-zekasi/veri-kaynaklari/#" class="menu-link px-3 py-2 fs-8">
    ...
    <div class="d-flex align-items-center gap-5 border-top border-bottom pw-border-neutral-200 px-6 py-2 my-4">
      <div class="font-poppins fs-8 pw-text-neutral-900 fw-bolder py-1 border-end pw-border-neutral-200 pe-5">
        7 Tanımlı Veri Kaynağı
      </div>
      <a href="/tanimlamalar/is-zekasi/veri-kaynaklari/#" class="btn p-0">
        <span class="btn p-0 fs-9 fs-semibold d-inline-flex align-items-center gap-2" data-bs-toggle="tooltip" data-bs-custom-class="tooltip-inverse" data-bs-placement="bottom" title="Yeni Veri Kaynağı Ekle">
          ...
          <span class="pw-text-black">Yeni Ekle</span>
        </span>
      </a>
    </div>
    <!--end::Actionbar-->
    ...
    <div class="col-12 col-md-11 mb-20 px-6 pb-6">
      ...
      <div id="kt_docs_search_handler_basic" class="w-100 mw-300px mb-3" data-kt-search-keypress="true" data-kt-search-min-length="2" data-kt-search-enter="true" data-kt-search-layout="inline">
        ...
        <form data-kt-search-element="form" class="position-relative" autocomplete="off">
          ...
          <!--begin::Input-->
          <input type="text" class="form-control pw-input-stroke py-2 ps-9 pe-2 fs-8" name="search" value="" placeholder="Veri Kaynaklarında ara" data-kt-search-element="input" />
          <!--end::Input-->
        ...
        <table class="table table-row-bordered border pw-dark-bg-table pw-table-border-gray pw-table-border-gray table-rounded align-middle w-max-content min-w-100 gy-2 gx-9 gs-9">
          <thead>
            <tr class="fw-semibold fs-8 pw-text-neutral-700 pw-bg-neutral-100">
              <th class="py-3">Veri Kaynakları</th>
          ...
          <tbody>
            ...
            <tr class="fw-medium pw-text-neutral-700 fs-8 cursor-pointer hover-pw-bg-primary-300" data-bs-toggle="modal" data-bs-target="#avas-talep-dokuman">
              ...
              <td align="right">
                <a href="tanimlamalar/is-zekasi/veri-kaynaklari/#" class="btn btn-icon pw-btn-bg-neutral-100 btn-text-primary pw-btn-hover-bg-neutral-200 w-30px h-30px rounded-0.5">
...
<!-- begin::Modal -->
<div class="modal fade" tabindex="-1" id="avas-talep-dokuman">
  <div class="modal-dialog modal-dialog-centered modal-lg mw-600px">
    <div class="modal-content">
      <div class="modal-header border-0 pb-3">
        <h3 class="modal-title fs-5">Avas Talep Döküman</h3>
      ...
      <div class="modal-body">
        <div class="table-responsive">
          <table class="table align-middle fs-8">
            <!--begin::Row-->
            <tr>
              <td class="fw-bolder">Adı</td>
              <td class="pw-text-neutral-800">Avas Talep Döküman</td>
            </tr>
            <!--end::Row-->

            <!--begin::Row-->
            <tr>
              <td class="fw-bolder">Kullanım Yeri</td>
              <td class="pw-text-neutral-800">Gösterge Paneli</td>
            </tr>
            <!--end::Row-->

            <!--begin::Row-->
            <tr>
              <td class="fw-bolder">Tanım</td>
              <td class="pw-text-neutral-800">Belge Taslağı Sistem</td>
            </tr>
            <!--end::Row-->
            ...
            <tr>
              ...
              <td class="pw-text-neutral-800">Lorem ipsum dolor sit amet, consecteur.</td>
            </tr>
            <!--end::Row-->
          </table>
        </div>
