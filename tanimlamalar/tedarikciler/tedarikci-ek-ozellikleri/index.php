...
<div class="app-wrapper flex-column flex-row-fluid" id="kt_app_wrapper">
  ...
  <div class="app-main flex-column flex-row-fluid" id="kt_app_main">
      ...
      <div id="kt_app_toolbar_container" class="container-fluid d-flex flex-stack p-0">
        ...
        <div class="page-title d-flex flex-column justify-content-center flex-wrap me-3">
          ...
          <ul class="breadcrumb breadcrumb-separatorless fw-semibold fs-8 mt-0 mb-3">
            ...
            <!--end::Item-->
            <!--begin::Item-->
            <li class="breadcrumb-item active">Tedarikçi Ek Özellikleri</li>
            <!--end::Item-->
          </ul>
          <!--end::Breadcrumb-->
          <!--begin::Title-->
        ...
        <div class="app-navbar-item ms-1 ms-md-3">
          <!--begin::Menu toggle-->
          <a href="/tanimlamalar/tedarikciler/tedarikci-ek-ozellikleri/#" class="btn btn-icon btn-custom btn-icon-muted btn-active-light btn-active-color-primary w-30px h-30px w-md-40px h-md-40px" data-kt-menu-trigger="{default:'click', lg: 'hover'}" data-kt-menu-attach="parent" data-kt-menu-placement="bottom-end">
          ...
          <div class="menu menu-sub menu-sub-dropdown menu-column menu-rounded menu-title-gray-700 menu-icon-gray-500 menu-active-bg menu-state-color fw-semibold py-4 fs-base w-200px" data-kt-menu="true" data-kt-element="theme-mode-menu">
            ...
            <div class="menu-item px-3 my-0">
              <a href="/tanimlamalar/tedarikciler/tedarikci-ek-ozellikleri/#" class="menu-link px-3 py-2 fs-8">
    ...
    <div class="d-flex align-items-center gap-5 border-top border-bottom pw-border-neutral-200 px-6 py-2 my-4">
      <a href="/tanimlamalar/tedarikciler/tedarikci-ek-ozellikleri/#" class="btn p-0">
        <span class="btn p-0 fs-9 fs-semibold d-inline-flex align-items-center gap-2" data-bs-toggle="tooltip" data-bs-custom-class="tooltip-inverse" data-bs-placement="bottom" title="Yeni Tedarikçi Ek Özelliği Ekle">
      ...
      <a href="/tanimlamalar/tedarikciler/tedarikci-ek-ozellikleri/#" class="btn p-0">
        <span class="btn p-0 fs-9 fs-semibold d-inline-flex align-items-center gap-2" data-bs-toggle="tooltip" data-bs-custom-class="tooltip-inverse" data-bs-placement="bottom" title="Kaydet">
          <div class="w-25px h-25px pw-bg-iconbg rounded-0.20rem d-inline-flex align-items-center justify-content-center">
