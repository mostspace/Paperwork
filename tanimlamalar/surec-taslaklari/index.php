...
<div class="app-wrapper flex-column flex-row-fluid" id="kt_app_wrapper">
    ...
    <div class="app-main flex-column flex-row-fluid" id="kt_app_main">
            ...
            <div id="kt_app_toolbar_container" class="container-fluid d-flex flex-stack p-0">
                ...
                <div class="page-title d-flex flex-column justify-content-center flex-wrap me-3">
                    ...
                    <ul class="breadcrumb breadcrumb-separatorless fw-semibold fs-8 mt-0 mb-3">
                        ...
                        <!--end::Item-->
                        <!--begin::Item-->
                        <li class="breadcrumb-item active">Süreç Taslakları</li>
                        <!--end::Item-->
                    </ul>
                    <!--end::Breadcrumb-->
                    <!--begin::Title-->
        ...
        <div class="d-flex align-items-center gap-5 border-top border-bottom pw-border-neutral-200 px-6 py-2 my-4">
            ...
            <a href="/tanimlamalar/surec-taslaklari/yeni" class="btn p-0">
                <span class="btn p-0 fs-9 fs-semibold d-inline-flex align-items-center gap-2" data-bs-toggle="tooltip" data-bs-custom-class="tooltip-inverse" data-bs-placement="bottom" title="Yeni Proje Ekle">
        ...
        <div class="col-12 col-md-11 mb-20 px-6 pb-6">
            ...
            <!--end::Search wrapper-->
            <!--begin::Süreç Taslakları tablosu-->
                ...
                <table class="table table-row-bordered border pw-dark-bg-table pw-table-border-gray pw-table-border-gray table-rounded align-middle w-max-content min-w-100 gy-2 gx-9 gs-9">
                    ...
                    <tbody>
                        ...
                        <tr class="fw-medium pw-text-neutral-700 fs-8">
                            <td>
                                <div class="d-flex align-items-center flex-nowrap gap-2">
                                    <div class="w-35px h-35px d-inline-flex align-items-center justify-content-center rounded-circle pw-bg-neutral-100 flex-shrink-0">
                                        <i class="fa-solid fa-badge-sheriff pw-text-primary-500"></i>
                                    </div>
                                    <div>
                                        ADT İşe Alım
                                    </div>
                            ...
                            <td>-</td>
                            <td align="right">
                                <a href="/tanimlamalar/surec-taslaklari/#surec-detay" class="btn btn-icon pw-btn-bg-neutral-100 btn-text-primary pw-btn-hover-bg-neutral-200 w-30px h-30px rounded-0.5"  data-bs-toggle="modal" data-bs-target="#surec-detay">
                                    <i class="fa-solid fa-eye fs-7 text-primary"></i>
                                </a>
                                <a href="/tanimlamalar/surec-taslaklari/#" class="btn btn-icon pw-btn-bg-neutral-100 btn-text-primary pw-btn-hover-bg-neutral-200 w-30px h-30px rounded-0.5">
        ...
        <div class="d-flex flex-column-reverse flex-sm-row align-items-center align-items-sm-end justify-content-center justify-content-sm-end gap-8 gap-sm-4 my-10">
            ...
            <ul class="pagination flex-nowrap flex-shrink-0">
                ...
                <li class="page-item active">
                    <a href="/tanimlamalar/surec-taslaklari/#" class="page-link pw-min-w-32px h-32px fs-8">1</a>
                </li>
                <!--end::Pagination item-->

                <!--begin::Pagination item-->
                <li class="page-item">
                    <a href="/tanimlamalar/surec-taslaklari/#" class="page-link pw-min-w-32px h-32px fs-8">2</a>
                </li>
                <!--end::Pagination item-->

                <!--begin::Pagination item-->
                <li class="page-item ">
                    <a href="/tanimlamalar/surec-taslaklari/#" class="page-link pw-min-w-32px h-32px fs-8">3</a>
                </li>
                <!--end::Pagination item-->

                <!--begin::Pagination item-->
                <li class="page-item ">
                    <a href="/tanimlamalar/surec-taslaklari/#" class="page-link pw-min-w-32px h-32px fs-8">4</a>
                </li>
                <!--end::Pagination item-->

                <!--begin::Pagination item-->
                <li class="page-item ">
                    <a href="/tanimlamalar/surec-taslaklari/#" class="page-link pw-min-w-32px h-32px fs-8">5</a>
                </li>
                <!--end::Pagination item-->

                <!--begin::Pagination item-->
                <li class="page-item next">
                    <a href="/tanimlamalar/surec-taslaklari/#" class="page-link pw-min-w-32px h-32px fs-8"><i class="next"></i></a>
                </li>
                <!--end::Pagination item-->
            </ul>
            <!--end::Pagination-->
    ...
    <!-- begin::Modal -->
    <div class="modal fade" tabindex="-1" id="surec-detay">
        <div class="modal-dialog modal-dialog-centered modal-lg mw-950px">
            <div class="modal-content">
                <div class="modal-header border-0 pb-3">
                    <h3 class="modal-title fs-5">ADT İşe Alım</h3>
                </div>
                            ...
                            <div class="table-responsive overflow-x-auto overflow-lg-hidden">
                                <table class="table w-min-content w-100 align-middle gy-5 gx-4">
                                    <tbody>
                                        ...
                                        <tr>
                                            <td>
                                                <label class="form-label fs-base fw-bolder">Proje Adı</label>
                                            </td>
                                            <td>
                                                ADT İşe Alım
                                            </td>
                                        ...
                                        <tr>
                                            <td>
                                                <label class="form-label fs-base fw-bolder">Açıklama</label>
                                            </td>
                                            <td>
                                                Aydın Des Tech firması işe alım sürecini desteklemek amacıyla üretilmiştir.
                                            </td>
                                        </tr>
                                        <!--end::Row-->
                                    </tbody>
