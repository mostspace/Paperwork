  ...
  <div class="app-main flex-column flex-row-fluid" id="kt_app_main">
    ...
    <div class="d-flex align-items-center gap-5 border-top border-bottom pw-border-neutral-200 px-6 py-2 my-4">
      <div class="font-poppins fs-8 pw-text-neutral-900 fw-bold py-1 border-end pw-border-neutral-200 pe-5">
        16 Tanımlı Yetki Seti
      </div>
      <a href="/tanimlamalar/kullanicilar/yetki-setleri/yeni-ekle/" class="btn p-0 fs-9 fs-semibold d-inline-flex align-items-center gap-2" data-bs-toggle="tooltip" data-bs-custom-class="tooltip-inverse" data-bs-placement="bottom" title="Yeni Yetki Seti Ekle">
        ...
        <table class="table table-row-bordered border pw-table-border-gray table-rounded align-middle w-max-content min-w-100 gy-2 gx-9 gs-9">
          <thead>
            <tr class="fw-semibold fs-8 pw-text-neutral-700 pw-bg-neutral-100">
              <th class="py-3 text-left">Adı</th>
              <th class="py-3">Yetki Seti No</th>
              <th class="py-3">Kullanım Şekli</th>
          ...
          <tbody>
            <!--begin::Row-->
            <tr class="fw-medium pw-text-neutral-700 fs-8 pw-bg-primary-100">
              <td>
              ...
              <td>
                <div id="copyText1" class="d-flex align-items-center gap-2 btn p-0">
                  <span class="copied-text fw-medium pw-text-neutral-700 fs-8">
                    A1002000000001F2
                  </span>
                  <button class="btn p-0" data-bs-toggle="tooltip" data-bs-custom-class="tooltip-inverse" data-bs-placement="top" title="Kopyala">
                    <i class="fa-solid fa-copy fs-base pw-text-neutral-300"></i>
                  </button>
                </div>
              </td>
              <td>Genel</td>
              ...
              <td>-</td>
              <td align="right">
                <a href="/tanimlamalar/yetki-kullanicilar/setleri/#kullanim-bilgisi" class="btn btn-icon pw-btn-bg-neutral-100 pw-btn-hover-bg-neutral-200 w-30px h-30px rounded-0.5" data-bs-toggle="modal" data-bs-target="#kullanim-bilgisi">
                  <i class="fa-solid fa-list-ul fs-7 pw-text-primary"></i>
                </a>
                <a href="/tanimlamalar/yetki-kullanicilar/setleri/#" class="btn btn-icon pw-btn-bg-neutral-100 pw-btn-hover-bg-neutral-200 w-30px h-30px rounded-0.5">
                  <i class="fa-solid fa-eye fs-7 pw-text-primary"></i>
                </a>
                <a href="/tanimlamalar/kullanicilar/yetki-setleri/detay" class="btn btn-icon pw-btn-bg-neutral-100 pw-btn-hover-bg-neutral-200 w-30px h-30px rounded-0.5">
              ...
              <td>
                <div class="d-flex align-items-center flex-nowrap gap-2">
                  <div class="w-35px h-35px  d-inline-flex align-items-center justify-content-center rounded-circle pw-bg-neutral-100 flex-shrink-0">
                    <i class="fa-solid fa-user-shield pw-text-primary-500"></i>
                  </div>
                  <div>
                    Analist
                  </div>
        ...
        <table class="table pw-dark-bg-table table-row-bordered border pw-table-border-gray table-rounded align-middle w-max-content min-w-100 gy-2 gx-9 gs-9 theme-dark-show">
          <thead>
            <tr class="fw-semibold fs-8 pw-text-neutral-700">
              <th class="py-3">ADI</th>
              <th class="py-3">YETKİ SETİ NO</th>
              <th class="py-3">KULLANIM ŞEKLİ</th>
              <th class="py-3">TİPİ</th>
