            ...
            <div class="table-responsive overflow-x-auto overflow-lg-hidden">
              <table class="table w-min-content w-100">
                <tbody>
                  ...
                  <tr>
                    <td>
                      <div class="form-label fs-base">Yetki Seti No</div>
                    </td>
                    <td>
                      <a href="#" class="link-primary link-underline fs-9">
                        A1002000000001F2
                      </a>
                    </td>
                  </tr>
      ...
      <table id="pw_erisim_ve_islem_yetkileri_table" class="table table-row-bordered border pw-table-border-gray table-rounded align-middle w-max-content min-w-100 gy-2 gx-9 gs-9">
        ...
        <tbody>
          ...
          <tr class="fw-medium pw-text-neutral-700 fs-8">
            ...
            <td>Yok</td>
            <td align="right">
              <a href="/tanimlamalar/kullanicilar/yetki-setleri/detay/#yetki-seti" class="btn btn-icon pw-btn-bg-neutral-100 pw-btn-hover-bg-neutral-200 w-30px h-30px rounded-0.5 me-2" data-bs-toggle="modal" data-bs-target="#yetki-seti">
          ...
          <tr class="fw-medium pw-text-neutral-700 fs-8">
            ...
            <td>Yok</td>
            <td align="right">
              <a href="/tanimlamalar/kullanicilar/yetki-setleri/detay/#yetki-seti" class="btn btn-icon pw-btn-bg-neutral-100 pw-btn-hover-bg-neutral-200 w-30px h-30px rounded-0.5 me-2">
                <i class="fa-solid fa-pen-to-square fs-7 text-primary"></i>
              </a>
              <a href="/tanimlamalar/kullanicilar/yetki-setleri/detay/#" class="btn btn-icon pw-btn-bg-neutral-100 pw-btn-hover-bg-neutral-200 w-30px h-30px rounded-0.5">
                <i class="fa-solid fa-trash fs-7 text-primary"></i>
